!(function () {
...
})()(
  {
    1: [
      function (t, e, i) {
        ...
        function s() {
          app.ajaxEnabled &&
            (M.default.init(),
            M.default.on("popState", g),
            M.default.on("loading", y),
            M.default.on("loaded", v));
        }
        function o() {
          (B = new j.default()),
        ...
        function l() {
          Q.default.init(),
            Q.default.on("linkClick", _),
            Q.default.on("gotoPageSection", A);
        }
        function h() {
          var t = "main-loading",
            e = Z[t];
          B.addItem(t, e),
            B.showScreen(t, E.Transitions.in, {
              arguments: [{ id: t }],
              events: { animateInComplete: S, complete: I },
            });
        }
        function p() {
          var t = "ajax-loading";
        ...
        function u() {
          ...
          if (!i) {
            var n = Z[e] || Z.default;
            i = B.addItem(e, n, {
              events: { linkClick: _, pushState: k, updateRequest: b },
            });
          }
          i.setOptions({
            canDispose: !1,
            arguments: [{ id: e, element: t, owner: B, isAjax: !!K.url }],
          }),
            (K.id = e),
        ...
        function g(t) {
          ...
          "ajax-loading" !== e.id &&
            "main-loading" !== e.id &&
            B.currentScreen.onPopState(event);
        }
        function y(t) {
          var e = B.currentScreen;
          if ("ajax-loading" === e.id || "main-loading" === e.id)
            return (
              K && f(), void ("main-loading" === e.id && e.resetProgress())
            );
          p();
        }
        function v(t) {
          if (200 !== t.status && 404 !== t.status)
            return void (location.href = app.baseUrl);
          (K = { data: t.pageData, url: t.url }), B.transitionRunning || u();
        }
        function b(t) {
          for (var e in t) {
            var i = t[e];
        ...
        function x() {
          ...
          z.default.hide(),
            "main-loading" !== t &&
              "ajax-loading" !== t &&
              (z.default.updateSelectedItem(B.currentItemId),
              J && ((J = !1), N.default.animateIn(), z.default.animateIn()));
        }
        function T() {
          var t = B.currentScreen.id;
          "main-loading" !== t &&
            "ajax-loading" !== t &&
            (tt && B.currentScreen.gotoSection(tt), (tt = null));
        }
        function S() {
          c();
        }
        ...
        function O() {
          var t = B.currentScreen;
          t && "main-loading" === t.id
            ? B.currentScreen.updateProgress(1)
            : d();
        }
        function C(t) {
          var e = B.currentScreen;
        ...
        function A(t) {
          ...
          i.setAttribute("href", e.url),
            i.pathname === t.pathname
              ? e.gotoSection(t.section)
              : ((tt = t.section), M.default.gotoHref(t.href));
        }
        ...
        !(function () {
          (window.app = window.app || {}),
            ...
            (app.isHdpi = (0, V.default)()),
            (app.hasTouch = Modernizr.touchevents),
            (app.ajaxEnabled = !0),
            app.hasHistory || (app.ajaxEnabled = !1),
            (app.urlQuery = window.location.search ? (0, X.default)() : {}),
            (app.IEVersion = (0, G.default)()),
      ...
      function (t, e, i) {
        ...
        function n(t, e) {
          Array.isArray(t)
            ...
            : (t.jquery || 1 === t.nodeType || "string" == typeof t) &&
              TweenMax.set(t, { clearProps: e });
        }
        (i.__esModule = !0),
    ...
    3: [
      function (t, e, i) {
        ...
        var n = function (t) {
          ...
          for (var e, i, n = 0; n < this.numFrames; n++)
            (e = t.frames[n].frame),
          ...
          l = (function (t) {
            ...
            return (
              ...
              (e.prototype.init = function () {
                $(".footer__page__title").on(
                  "click",
                  this.onPageClick.bind(this)
                ),
                  $(".footer__page__section__title").on(
                    "click",
                    this.onPageSectionClick.bind(this)
                  ),
                  $("#footer__bottom a").on(
                    "click",
                    this.onBottomLinkClick.bind(this)
                  );
              }),
              ...
              (e.prototype.onPageSectionClick = function (t) {
                ...
                if (!e.hash || !e.hash.length)
                  return void this.emit("linkClick", t);
                t.preventDefault(),
          ...
          l = (function (t) {
            ...
            return (
              ...
              (e.prototype.updateSize = function (t) {
                t !== this.size &&
                  ((this.size = t),
                  this.element.toggleClass("logo--small", "small" === t));
              }),
              (e.prototype.updateColor = function (t) {
                t !== this.color &&
                  ((this.color = t),
                  this.element.toggleClass("logo--dark", "dark" === t));
              }),
          ...
          return (
            ...
            (e.prototype.init = function () {
              (this.isVisible = !1),
                ...
                p.default.init(),
                p.default.on("click", this.onToggleBtnClick.bind(this)),
            ...
            (e.prototype.disposeTimelineShow = function () {
              this.timelineShow &&
                ...
                (0, u.default)(this.timelineShow),
                (this.timelineShow = null));
            }),
            (e.prototype.disposeTimelineHide = function () {
              this.timelineHide &&
                (this.timelineHide.kill(),
                (0, u.default)(this.timelineHide),
                (this.timelineHide = null));
            }),
            (e.prototype.disposeTimelineStyle = function () {
              this.timelineStyle &&
                (this.timelineStyle.kill(),
                (0, u.default)(this.timelineStyle),
                (this.timelineStyle = null));
            }),
            (e.prototype.resize = function (t) {
              ...
              var e = app.windowWidth / this.bgSourceWidth,
                ...
                r = parseInt(-0.5 * (s - app.windowWidth)),
                a = parseInt(-0.5 * (o - app.windowHeight));
              this.bg.css({ left: r, top: a, width: s, height: o }),
                app.windowWidth >= app.screenM
                  ? this.hasScrollListener || this.addScrollListener()
                  : this.hasScrollListener && this.removeScrollListener();
            }),
            ...
            (e.prototype.updateSelectedItem = function (t) {
              this.selectedItem &&
                this.selectedItem.removeClass("nav__item--selected"),
            ...
            (e.prototype.updateStyle = function (t) {
              this.style !== t &&
                ...
                (this.timelineStyle = new TimelineMax({
                  onComplete: this.onTimelineStyleComplete.bind(this),
                })),
                (this.style = t),
                app.windowWidth >= app.screenM
                  ? "fullscreen" === this.style
                    ? (this.element[0].getBoundingClientRect().top > 0 &&
                        this.timelineStyle.add(this.animateOutInline()),
                      this.timelineStyle
                        .add(this.applyStyleClass.bind(this))
                        .add(p.default.animateIn()))
                    : this.timelineStyle
                        .add(p.default.animateOut())
                        .add(this.applyStyleClass.bind(this))
                        .add(this.animateInInline())
            ...
            (e.prototype.show = function () {
              this.isVisible ||
                ((this.isVisible = !0),
                p.default.update({ state: "close" }),
                this.disposeTimelineShow(),
                this.disposeTimelineHide(),
                (this.timelineShow = new TimelineMax({
                  delay: 0.4,
                  ...
                  .staggerFrom(
                    ...
                    0.8,
                    { y: 60, opacity: 0, ease: Expo.easeOut },
                    0.1,
                    0.2
                  )
                  .addLabel("bg", 0.2)
                  .fromTo(
                    ...
                    { scale: 1, rotation: 0, ease: Quart.easeOut },
                    "bg"
                  )
                  .fromTo(
                    this.bgPaths[0],
                    1.4,
                    { drawSVG: "100% 100%" },
                    { drawSVG: "0% 100%", ease: Quart.easeOut },
                    "bg"
                  )
                  .fromTo(
                    this.bgPaths[1],
                ...
                (this.content[0].style.visibility = "inherit"));
            }),
            (e.prototype.hide = function () {
              this.isVisible &&
                ((this.isVisible = !1),
                p.default.update({ state: "list" }),
                this.disposeTimelineShow(),
                this.disposeTimelineHide(),
                (this.timelineHide = new TimelineMax({
            ...
            (e.prototype.animateIn = function () {
              (this.timelineIn = new TimelineMax({
                ...
                app.windowWidth >= app.screenM
                  ? this.timelineIn.add(this.animateInInline())
                  : this.timelineIn.add(p.default.animateIn());
            }),
            (e.prototype.animateInInline = function () {
              return TweenMax.staggerFrom(
                this.items,
                0.8,
                { xPercent: 100, opacity: 0, ease: Expo.easeOut },
                0.05
              );
            }),
            (e.prototype.animateOutInline = function () {
              return TweenMax.staggerTo(
                this.items,
                0.4,
                { xPercent: 100, opacity: 0, ease: Expo.easeIn },
                -0.03
              );
            }),
            ...
            (e.prototype.onLinkMouseEnter = function (t) {
              this.element.toggleClass(
                "nav--right-dir",
                -1 === this.mouseXDirection
              );
            }),
            (e.prototype.onScroll = function (t) {
              window.pageYOffset > this.minScrollTop
                ? this.updateStyle("fullscreen")
    ...
    8: [
          ...
          c = (function (t) {
            ...
            return (
              ...
              (e.prototype.disposeTimelineState = function () {
                this.timelineState &&
                  (this.timelineState.kill(),
                  (0, p.default)(this.timelineState),
              ...
              (e.prototype.updateColor = function (t) {
                t !== this.color &&
                  ((this.color = t),
                  this.element.toggleClass("nav-toggle--dark", "dark" === t));
              }),
                    ...
                    "close" === this.state
                      ? this.timelineState
                          .staggerTo(
                            ...
                            0.3,
                            { x: n, ease: Quart.easeIn },
                            0.06
                          )
                          .add(this.applyStateClass.bind(this))
                          .add("close")
                          .from(
                            ".nav-toggle__cross__line",
                            0.8,
                            { rotation: 0, ease: Expo.easeOut },
                            "close+=.1"
                          )
                          .from(
                            this.element,
      ...
      { "anim/gsap/clear-timeline": 2, "tiny-emitter": 102 },
    ],
    9: [
      function (t, e, i) {
        "use strict";
          ...
          (i._gsQueue || (i._gsQueue = [])).push(function () {
            ...
            function e(t) {
              return (
                ("string" != typeof t && t.nodeType) ||
                  ((t = i.TweenLite.selector(t)), t.length && (t = t[0])),
                t
              );
            }
            function n(t, e, i) {
            ...
            function s(i) {
              ...
              if ("path" === c) n = i.getTotalLength() || 0;
                ...
                (s = i.getBBox()), (n = 2 * (s.width + s.height));
              else if ("circle" === c)
                ...
                for (
                  o = i.getAttribute("points").split(" "),
                    n = 0,
                    a = o[0].split(","),
                    "polygon" === c &&
                      (o.push(o[0]), -1 === o[0].indexOf(",") && o.push(o[1])),
                    l = 1;
                  l < o.length;
                  l++
                )
                  (r = o[l].split(",")),
                    1 === r.length && (r[1] = o[l++]),
                    2 === r.length &&
                      ((n += t(a[0], a[1], r[0], r[1]) || 0), (a = r));
              else
                "ellipse" === c &&
                  ((h = parseFloat(i.getAttribute("rx"))),
                  (p = parseFloat(i.getAttribute("ry"))),
                  (n =
                    Math.PI *
                    (3 * (h + p) - Math.sqrt((3 * h + p) * (h + 3 * p)))));
              return n || 0;
            }
            function o(t, i) {
              if (!t) return [0, 0];
            ...
            (r = i._gsDefine.plugin({
              ...
              init: function (t, e, i) {
                ...
                return (
                  ...
                  (this._length = h + 10),
                  0 === r[0] && 0 === a[0]
                    ? ((l = Math.max(1e-5, a[1] - h)),
                      (this._dash = h + l),
                      (this._offset = h - r[1] + l),
                      this._addTween(
                        this,
                        "_offset",
                        this._offset,
            ...
            var t = document.documentElement,
              ...
              s = function (i, n) {
                var s = "x" === n ? "Width" : "Height",
                  ...
                  a = document.body;
                return i === e || i === t || i === a
                  ? Math.max(t[o], a[o]) - (e["inner" + s] || t[r] || a[r])
                  : i[o] - i["offset" + s];
              },
          ...
          !(function (t) {
            var e = t.GreenSockGlobals || t,
                ...
                return (
                  (i = i || o(t, null))
                    ? ((t = i.getPropertyValue(
                        e.replace(r, "-$1").toLowerCase()
                      )),
                      (s = t || i.length ? t : i[e]))
                    : t.currentStyle && ((i = t.currentStyle), (s = i[e])),
                  n ? s : parseInt(s, 10) || 0
                );
              },
              l = function (t) {
              ...
              y = function (t, e, i, r, l) {
                c.test(t.innerHTML) &&
                  (t.innerHTML = t.innerHTML.replace(c, p));
                var h,
                  u,
                  f,
                  m,
                ...
                for (
                  ...
                  if (")" === (b = P.charAt(y)) && P.substr(y, 20) === p)
                    (m += (G ? "</div>" : "") + "<BR/>"),
                      (G = !1),
                      y !== h - 20 &&
                        P.substr(y + 20, 20) !== p &&
                    ...
                    for (
                      ...
                      (m += M), y++;
                    (")" === P.charAt(y + 1) && P.substr(y + 1, 20) === p) ||
                      ((m += M + X()), (G = !0));
                    ...
                    (x = w[y]),
                      ((f = x.parentNode === t) || R || (j && !E)) &&
                        ...
                        R &&
                          ...
                          (x._h = x.offsetHeight)),
                        A &&
                          ((E !== f && j) || (u.push(x), (x._x -= F)),
                          f && y && (w[y - 1]._wordEnd = !0),
                          "BR" === x.nodeName &&
                            x.nextSibling &&
                      ...
                      ? (R &&
                        ...
                        E
                          ? f && "" !== x.innerHTML
                            ...
                            : j && Z.push(x)
                          : f
                          ? (t.removeChild(x), w.splice(y--, 1), h--)
                          : !f &&
                            j &&
                            ((T = !A && !R && x.nextSibling),
                            t.appendChild(x),
                            T || t.appendChild(s.createTextNode(" ")),
                            Z.push(x)))
                      : A || R
                      ? (t.removeChild(x), w.splice(y--, 1), h--)
                      : E || t.appendChild(x);
                  ...
                  for (C = !R || (!E && !j), y = 0; y < A.length; y++) {
                    for (
                      ...
                      "BR" !== u[v].nodeName &&
                        ...
                        C &&
                          (x._wordEnd || E) &&
                          S.appendChild(s.createTextNode(" ")),
                        R &&
                          (0 === v &&
                            ((S.style.top = x._y + "px"),
                            (S.style.left = F + T + "px")),
                    ...
                    0 === h && (S.innerHTML = "&nbsp;"),
                      E ||
                        ...
                        (S.innerHTML = n(S)
                          ...
                          .join(" ")),
                      R &&
                        ((S.style.width = O), (S.style.height = x._h + "px")),
                      t.appendChild(S);
                  }
                  t.style.cssText = I;
                }
                R &&
                  (V > t.clientHeight &&
                    ((t.style.height = V - D + "px"),
                    t.clientHeight < V && (t.style.height = V + N + "px")),
                  Y > t.clientWidth &&
                    ((t.style.width = Y - H + "px"),
                    t.clientWidth < Y && (t.style.width = Y + B + "px"))),
                  g(i, Z),
                  g(r, J),
                  g(l, K);
              },
    ...
    13: [
        ...
        var a = t("tiny-emitter"),
          ...
          c = (function (t) {
            ...
            return (
              r(e, t),
              (e.prototype.init = function () {
                var t = { href: window.location.href, isFirstState: !0 };
                (this.initialized = !0),
                  (this.isLoading = !1),
                      ...
                      ((0, p.default)(e.href) &&
                        (e.target ||
                          ...
                          e.pathname !== window.location.pathname &&
                            this.gotoHref(e.href)))));
                }
              }),
              (e.prototype.onPopState = function (t) {
                if (t.state) {
                  if ((this.emit("popState", t.state), t.defaultPrevented))
                    return;
      ...
      { "tiny-emitter": 102, "utils/location/is-same-origin": 66 },
    ],
    14: [
      function (t, e, i) {
        "use strict";
        ...
        var r = t("net/loader/asset-library/AssetItem"),
          ...
          l = (function (t) {
            ...
            return (
              ...
              (e.prototype.isComplete = function () {
                return (
                  t.prototype.isComplete.call(this), 4 === this.xhr.readyState
                );
              }),
              (e.prototype.load = function () {
                t.prototype.load.call(this),
    ...
    17: [
            ...
            return (
              ...
              (e.prototype.checkStatus = function (t) {
                (this.loadElapsedTime = t - this.loadStartTime),
                  this.isComplete() ||
                    (this.loadElapsedTime >= this.noProgressTimeout &&
                      this.onTimeout());
              }),
              (e.prototype.isComplete = function () {}),
              ...
              (e.prototype.onError = function () {
                (this.status = p.default.ERROR),
                  this.log(
                    "AssetItem error: The resource " +
                      this.url +
                      " cannot be loaded."
                  ),
                  "function" == typeof this.options.onError &&
                    this.options.onError.call(this, this),
                  this.removeEventHandlers(),
                  this.emit("error", this);
              }),
              (e.prototype.onTimeout = function () {
                (this.status = p.default.TIMEOUT),
                  this.log(
                    "AssetItem timeout: The resource " +
                      this.url +
                      " cannot be loaded."
                  ),
                  "function" == typeof this.options.onError &&
                    this.options.onTimeout.call(this, this),
                  this.removeEventHandlers(),
                  this.emit("timeout", this);
              }),
              (e.prototype.onComplete = function () {
                this.status === p.default.LOADING &&
                  ((this.status = p.default.COMPLETE),
                  this.removeEventHandlers(),
                  "function" == typeof this.options.onComplete &&
                    this.options.onComplete.call(this, this),
                  0 !== this.delayedComplete
                    ? setTimeout(
                        this.dispatchComplete.bind(this),
                        1e3 * this.delayedComplete
                      )
      ...
      { "net/loader/asset-library/AssetStatus": 20, "tiny-emitter": 102 },
    ],
    18: [
      function (t, e, i) {
        "use strict";
        ...
        var r = t("net/loader/asset-library/AssetItem"),
          ...
          l = (function (t) {
            ...
            return (
              ...
              (e.prototype.isComplete = function () {
                return (
                  t.prototype.isComplete.call(this),
              ...
              (e.prototype.load = function () {
                t.prototype.load.call(this),
                  this.isComplete()
                    ? this.onComplete()
                    : (this.value.classList.add("lazyload"),
                      lazySizes.loader.unveil(this.value));
              }),
              (e.prototype.onLoad = function () {
                (1 === this.value.naturalWidth &&
                  1 === this.value.naturalHeight) ||
                  this.onComplete();
              }),
              e
            );
          ...
          O = (function (t) {
            function e(i) {
              ...
              return (
                (r.id = i || a()),
                (r.onCompleteCb =
                  n.onComplete && "function" == typeof n.onComplete
                    ? n.onComplete
                    : null),
                (r.onProgressCb =
                  n.onProgress && "function" == typeof n.onProgress
                    ? n.onProgress
                    : null),
                (r.baseUrl = n.baseUrl || ""),
                (r.verbose = void 0 === n.verbose || n.verbose),
            ...
            return (
              ...
              (e.prototype.addItem = function (t) {
                ...
                if (
                  ...
                  t.hasOwnProperty("isAssetItem")
                )
                  return (e = t), (this.items[s] = e), this.queue.push(e), e;
                var o,
                  r = void 0 !== i.verbose ? i.verbose : this.verbose,
                ...
                return o
                  ? (i.baseUrl || (i.baseUrl = this.baseUrl),
                    (i.url = n),
                    (i.verbose = r),
                    i.noProgressTimeout ||
                      (i.noProgressTimeout = this.noProgressTimeout),
                    (e = new o(t, i)),
                    (this.items[s] = e),
                    this.queue.push(e),
                    e)
              ...
              (e.prototype.load = function () {
                (this.loadStartTime = Date.now()),
                  this.processQueue(),
                  (this.checkStatusCbId = setTimeout(
                    this.checkStatusCb,
        ...
        var r = t("net/loader/asset-library/AssetItem"),
          ...
          l = (function (t) {
            ...
            return (
              ...
              (e.prototype.isComplete = function () {
                return (
                  t.prototype.isComplete.call(this), 4 === this.video.readyState
                );
              }),
              (e.prototype.load = function () {
    ...
    22: [
            ...
            return (
              ...
              (e.prototype.resizeShape2 = function () {
                ...
                (this.shape2[0].style.top = i + "px"),
                  (this.shape2ScrollTopEnd =
                    e.top + window.pageYOffset - app.windowHeight + e.height),
              ...
              (e.prototype.startTicker = function () {
                this.isTicking ||
                  ((this.isTicking = !0),
                  (this.onFrameCbId = (0, p.default)(this.onFrameCb)));
              }),
              (e.prototype.stopTicker = function () {
                this.isTicking &&
                  ((this.isTicking = !1), p.default.cancel(this.onFrameCbId));
              }),
              (e.prototype.initScroll = function () {}),
              (e.prototype.renderScroll = function () {
                var t = !1;
                if (this.shape2IsActive) {
                  (this.shape2ScrollTop +=
                    0.1 * (this.scrollTop - this.shape2ScrollTop)),
                    (this.shape2ScrollTopProgress =
                      this.shape2ScrollTop / this.shape2ScrollTopEnd),
                    this.shape2ScrollTopProgress > 1 &&
                      (this.shape2ScrollTopProgress = 1);
                  var e = this.shape2YEnd * this.shape2ScrollTopProgress,
                    i =
                      this.shape2ScaleYStart +
                      (this.shape2ScaleYEnd - this.shape2ScaleYStart) *
                        this.shape2ScrollTopProgress;
                  this.shape2[0].style[this.transformProperty] =
                    "translate3d(0," + e + "px,0) scaleY(" + i + ")";
                  (t =
                    Math.abs(
                      this.shape2ScrollTopProgress -
                        this.shape2ScrollTopProgressOld
                    ) > 0.001),
                    (this.shape2ScrollTopProgressOld =
                      this.shape2ScrollTopProgress),
                    this.shape2ScrollTopProgress > 0.999 &&
                      ((this.shape2IsActive = !1), this.showBodyImg());
                }
                t || (this.scrollIsSleeping = !0);
              }),
              (e.prototype.showBodyImg = function () {
                TweenMax.to(this.shape2, 0.3, { autoAlpha: 0 }),
                  TweenMax.to(
                    this.element.find("#about__body__img__overlay"),
                    0.9,
                ...
                var e = this.header[0].getBoundingClientRect(),
                  ...
                  o = new TimelineMax()
                    ...
                    .to(
                      i,
                      1.3,
                      { scaleY: 0.1, y: 0.9 * e.height, ease: Quart.easeInOut },
                      0
                    )
                    .to(
                      i,
                    ...
                    .from(
                      n,
                      0.5,
                      { opacity: 0, y: 30, ease: Quart.easeOut },
                      "-=.5"
                    )
                    .from(
                      this.element.find("#about__body__intro"),
                      0.7,
                      { opacity: 0, y: 30, ease: Quart.easeOut },
                      "-=.6"
                    );
              ...
              (e.prototype.onVideoCTAClick = function (t) {
                var e = t.currentTarget,
                  ...
                  o =
                    ...
                    s +
                    '?color=fff&autoplay=1" width="100%" height="100%" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>';
              ...
              (e.prototype.onScroll = function (t) {
                app.windowWidth < app.screenS ||
                  ...
                  this.scrollIsSleeping &&
                    ((this.scrollIsSleeping = !1), this.startTicker()));
              }),
              e
            );
          })(l.default);
      ...
      { "pages/BasePage": 24, raf: 79, "utils/css/prefix-property": 64 },
    ],
    23: [
      function (t, e, i) {
        "use strict";
        ...
        var a,
          ...
          g = (function (t) {
            ...
            return (
              ...
              (e.prototype.init = function () {
                (this.initialized = !0),
                  (this.txtTween = TweenMax.fromTo(
                    "#ajax-loading__txt",
                    0.8,
                    { autoAlpha: 0 },
                    { autoAlpha: 1, repeat: -1, yoyo: !0, ease: Sine.easeInOut }
                  )),
              ...
              (e.prototype.animateIn = function (e) {
                t.prototype.animateIn.call(this, e),
                  ...
                  e ||
                    ...
                    (this.element[0].style.visibility = "inherit"),
                    this.initialized
                      ? (this.txtTween.play(0), this.anim.gotoAndPlay(0))
                      : this.init(),
                    (this.timelineIn = new TimelineMax({
                      onComplete: this.onAnimateInComplete.bind(this),
                    })
              ...
              (e.prototype.animateOut = function (e) {
                if (
                  ...
                  return void this.onAnimateOutComplete();
                this.timelineOut = new TimelineMax({
                  onComplete: this.onAnimateOutComplete.bind(this),
                })
                  .to("#ajax-loading__overlay", 0.8, { opacity: 0 }, 0)
                  .fromTo(
                    "#ajax-loading__outer",
                    0.8,
                    { yPercent: 0 },
                    { yPercent: -100, ease: Expo.easeInOut },
                    0
                  )
                  .fromTo(
                    "#ajax-loading__inner",
              ...
              (e.getLoader = function () {
                ...
                return (
                  a.addItem(i, { id: "img" }), a.addItem(n, { id: "data" }), a
                );
              }),
              e
            );
          ...
          d = (function (t) {
            function e(i) {
              ...
              return (
                ...
                (n.screenData = { id: n.id, url: n.url, routeId: n.routeId }),
                (n.uid =
                  Math.random().toString(36).substring(2, 15) +
                  Math.random().toString(36).substring(2, 15)),
                (n.initialized = !1),
            ...
            return (
              ...
              (e.prototype.initPage = function () {
                (this.container = $("#page-container")),
                  ...
                  (this.links = this.element
                    .find("a")
                    .not('[data-ajax="false"]')
                    .on("click." + this.uid, this.onLinkClick.bind(this))),
                  (this.initialized = !0);
              }),
              ...
              (e.prototype.resize = function (t) {}),
              (e.prototype.animateIn = function (e) {
                if ((t.prototype.animateIn.call(this, e), e))
                  return void this.onAnimateInComplete();
                this.resize(),
              ...
              (e.prototype.onAnimateOutComplete = function () {
                this.initialized &&
                  (this.element.remove(),
                  (this.prevScreenData && this.prevScreenData.id === this.id) ||
                    this.body.removeClass("page-id-" + this.id)),
                  t.prototype.onAnimateOutComplete.call(this);
              }),
              (e.prototype.onLinkClick = function (t) {
                this.emit("linkClick", t);
        ...
        var h = t("utils/google/maps/google-maps-api"),
          ...
          m = (function (t) {
            ...
            return (
              ...
              (e.prototype.initPage = function () {
                t.prototype.initPage.call(this),
                  (this.subtitleBtns = $("#contact__subtitle span").on(
                    "click",
                    this.onSubtitleBtnClick.bind(this)
                  )),
              ...
              (e.prototype.initMap = function () {
                (this.onMapReadyCb = this.onMapReady.bind(this)),
                  p.default.isReady
                    ? this.addMap()
                    : (p.default.on("ready", this.onMapReadyCb),
                      this.loadMap());
              }),
              (e.prototype.initJobs = function () {
                this.element.on(
                  ...
                  this.onMoreBtnClick.bind(this)
                ),
                  (this.jobCloseBtns = this.element
                    .find(".contact__jobs__item__close")
                    .on("click", this.onCloseBtnClick.bind(this))),
                  (this.jobApplyBtns = this.element
                    .find(".contact__jobs__item__apply")
                    .on("click", this.onJobApplyBtnClick.bind(this))),
                  this.truncateJobs();
              }),
              (e.prototype.dispose = function () {
                t.prototype.dispose.call(this),
                  this.initialized &&
                    (this.subtitleBtns.off("click"),
                    p.default.off("ready", this.onMapReadyCb),
                    this.element.off("click", ".contact__jobs__item__more"),
                    this.jobCloseBtns.off("click"),
                    this.form.dispose(),
                    this.jobApplyBtns.off("click"));
              }),
              (e.prototype.resize = function (e) {
                ...
                var e = this.element.find("#contact__header__txt"),
                  ...
                  r = new TimelineMax()
                    ...
                    .to(
                      n,
                      0.7,
                      { scaleX: i.width / o.width, ease: Quart.easeInOut },
                      "-=.2"
                    )
                    .to(
                      n,
                      0.7,
                      { scaleY: o.height / i.height, ease: Quart.easeInOut },
                      "-=.2"
                    )
                    .to(
                      n,
                      0.7,
                      { scaleY: 0, y: i.bottom - o.top, ease: Quart.easeInOut },
                      "-=.2"
                    )
                    .staggerFrom(
                      [
                      ...
                      0.7,
                      { opacity: 0, y: 40, ease: Expo.easeOut },
                      0.07,
                      "-=.4"
                    );
                this.timelineIn
              ...
              (e.prototype.truncateJobs = function () {
                this.element
                  .find(".contact__jobs__item__desc")
                  .each(function (t, e) {
                    var i = $(e),
                    ...
                    if (parseInt(o / r) <= 5)
                      i.removeClass("contact__jobs__item__desc--truncated");
                    else {
                      i.addClass("contact__jobs__item__desc--truncated"),
                        s.text(n.text());
                      var a = new u.default(s, { type: "lines,words" });
                      if (a.lines.length > 5) {
                        var l = $(a.lines[4]),
                          h = $(
                            '<button class="contact__jobs__item__more">More info</button>'
                          );
                        l.append(h);
                        for (
                          var p = h.width(),
              ...
              (e.prototype.loadMap = function () {
                ...
                t.setAttribute(
                  "src",
                  "https://maps.googleapis.com/maps/api/js?callback=onGoogleMapsAPIReady&key=AIzaSyB81MGIQPC3uivyhXpP4LxIzMQ-rQzNT6w"
                ),
                  $("head").append(t);
              }),
              (e.prototype.addMap = function () {
                var t = document.getElementById("contact__infos__map"),
                  e = new google.maps.Map(t, {
                    center: { lat: 41.9952024, lng: -87.970799 },
                    zoom: 15,
                    minZoom: 5,
                    mapTypeControl: !1,
                    scrollwheel: !1,
                ...
                new google.maps.Marker({
                  position: { lat: 41.9952024, lng: -87.970799 },
                  map: e,
                });
              }),
              (e.prototype.onAnimateInComplete = function () {
              ...
              (e.prototype.onCloseBtnClick = function (t) {
                ...
                i.height(n.height()).removeClass(
                  "contact__jobs__item__desc--expanded"
                );
              }),
              ...
              (e.prototype.onSubtitleBtnClick = function (t) {
                var e = t.currentTarget,
                  ...
                  n = parseInt(this.form.element.offset().top);
                this.element
                  .find(".contact__form__subject__item input[value=" + i + "]")
                  .prop("checked", !0)
                  .trigger("change"),
                  TweenMax.to(window, 0.7, {
                    scrollTo: { y: n },
            ...
            (function (t) {
              ...
              return (
                ...
                (e.prototype.initScreenNavigator = function () {
                  ...
                  (this.screenNavigator = new p.default()),
                    ...
                    e.each(function (e, i) {
                      ...
                      t.screenNavigator.addItem(n, s, {
                        ...
                        events: {
                          ...
                          stepAnimateInComplete:
                            t.onStepAnimateInComplete.bind(t),
                ...
                (e.prototype.initPagination = function () {
                  (this.pagination = new y.default()),
                    ...
                    this.pagination.on(
                      "timerComplete",
                      this.onPaginationTimerComplete.bind(this)
                    );
                }),
                (e.prototype.initScrollCTA = function () {
                  (this.scrollCTA = new b.default()),
                    this.scrollCTA.on(
                      "click",
                      this.onScrollCTAClick.bind(this)
                    );
                }),
                ...
                (e.prototype.dispose = function () {
                  t.prototype.dispose.call(this),
                    this.initialized &&
                      ...
                      this.scrollCTA.off("click"),
                      this.scrollCTA.dispose(),
                      this.window.off("keyup." + this.uid),
                      (this.window = null),
                      this.element.off("DOMMouseScroll mousewheel"),
                      this.logo.off("click." + this.uid));
                }),
                (e.prototype.populateLoader = function () {
                  var e = this;
                  if ((t.prototype.populateLoader.call(this), this.hasVideo)) {
                    var i = this.element.find("#home-landing__bg__video")[0];
                    this.loader.addItem(i, { type: "video" });
                  } else
                    this.element
                      .find(".home-screen__step-1__bg")
                      .each(function (t, i) {
                        var n =
                          app.baseUrl +
                          "/assets/img/home-screen-" +
                          (t + 1) +
                          "-step-1.jpg";
                        e.loader.addItem(n, {
                ...
                (e.prototype.resize = function (e) {
                  t.prototype.resize.call(this, e),
                    this.screenNavigator &&
                      this.screenNavigator.currentScreen &&
                      this.screenNavigator.currentScreen.resize(e),
                ...
                (e.prototype.resizeVideoLanding = function () {
                  var t = app.windowWidth >= app.screenXL,
                    e =
                      this.screenNavigator &&
                      this.screenNavigator.currentScreen &&
                      "landing" === this.screenNavigator.currentScreen.id;
                ...
                (e.prototype.populateTimelineIn = function () {
                  t.prototype.populateTimelineIn.call(this),
                    ...
                    this.timelineIn.add(
                      this.screenNavigator.currentScreen.timelineIn
                    );
                }),
                ...
                (e.prototype.gotoNextStep = function () {
                  this.screenNavigator.transitionRunning ||
                    this.screenNavigator.currentScreen.gotoNextStep();
                }),
                (e.prototype.gotoPrevStep = function () {
                  this.screenNavigator.transitionRunning ||
                    this.screenNavigator.currentScreen.gotoPrevStep();
                }),
                (e.prototype.gotoScreen = function (t) {
                  ...
                  if (this.screenNavigator.getItem(i)) {
                    if (t !== this.screenNavigator.currentScreen.index) {
                      var n =
                        this.screenNavigator.currentScreen.index > t ? -1 : 1;
                      this.screenNavigator.showScreen(i, null, {
                        properties: { direction: n, firstStepId: e },
                      });
                    }
                  }
                }),
                ...
                (e.prototype.onStepAnimateInStart = function (t) {
                  var e =
                    "screen-7" === this.screenNavigator.currentScreen.id &&
                    "step-2" === t.id;
                  this.updateRequest(t.elementsToUpdate),
                    t.elementsToUpdate["scroll-cta"] &&
                      this.scrollCTA.update(t.elementsToUpdate["scroll-cta"]),
                    this.pagination.updateIndex(
                      this.screenNavigator.currentScreen.index
                    ),
                    t.elementsToUpdate.pagination &&
                      this.pagination.update(t.elementsToUpdate.pagination),
                ...
                (e.prototype.onStepAnimateInComplete = function (t) {
                  "step-1" === t.stepId &&
                    this.pagination.startTimer(t.screenIndex);
                }),
                (e.prototype.onStepAnimateOutStart = function (t) {
                  "step-1" === t.stepId &&
                    this.pagination.stopTimer(t.screenIndex);
                }),
                (e.prototype.onScrollCTAClick = function () {
                  this.scrollCTA.isReversed
                    ? this.gotoScreen(1)
                    : this.gotoNextStep();
                }),
                (e.prototype.onAnimateInComplete = function () {
                ...
                (e.prototype.onAnimateOutComplete = function () {
                  var e = { logo: { size: null }, nav: { style: null } };
                ...
                (e.prototype.onScroll = function (t) {
                  ...
                  if (
                    -1 !==
                    e.parentNode.className.indexOf(
                  ...
                  t.preventDefault(),
                    ...
                    (t.originalEvent.detail && t.originalEvent.detail > 0)
                      ? this.gotoNextStep()
                      : this.gotoPrevStep();
                }),
                (e.prototype.onKeyUp = function (t) {
                ...
                (e.prototype.onSwipe = function (t) {
                  t.direction === Hammer.DIRECTION_UP
                    ? this.gotoNextStep()
                    : t.direction === Hammer.DIRECTION_DOWN &&
                      this.gotoPrevStep();
                }),
    ...
    27: [
          ...
          return (
            ...
            (e.prototype.dispose = function () {
              t.prototype.dispose.call(this),
                ...
                this.logoTimeline &&
                  (this.logoTimeline.kill(), (this.logoTimeline = null));
            }),
            (e.prototype.resize = function (t) {
              ...
              if (
                ((this.linesScale = n),
                this.lines.css({ left: r, top: a, width: s, height: o }),
                this.logoTimeline)
              ) {
            ...
            (e.prototype.animateIn = function (e) {
              t.prototype.animateIn.call(this, e),
                ...
                (this.timelineIn = new TimelineMax({})
                  ...
                  .add(this.startProgress.bind(this), 0.3));
            }),
            (e.prototype.startProgress = function () {
              ...
              (this.progressTimeline = new TimelineMax({
                ...
                .to(
                  t[t.length - 1],
                  1,
                  { drawSVG: "100% 100%", ease: Quad.easeInOut },
                  0
                )
                .to(
                  t[t.length - 2],
                ...
                this.updateProgress(0.45, this.progress ? null : 3);
            }),
            (e.prototype.resetProgress = function () {
              TweenMax.killTweensOf({ progress: !0 }),
                (this.progress = 0),
                this.onProgressTweenUpdate(),
                this.updateProgress(0.45, 1);
            }),
            (e.prototype.animLogo = function () {
              ...
              new TimelineMax({
                ...
                .to(
                  [t[t.length - 10], t[t.length - 11], t[t.length - 12]],
                  1,
                  { strokeWidth: 64, stroke: "#000", ease: Expo.easeInOut },
                  0
                )
                .to(
                  this.lines,
                ...
                .to(
                  $("#main-loading__logo"),
                  1,
                  { x: parseInt(53) + 7, ease: Expo.easeInOut },
                  0
                );
            }),
            (e.prototype.animateOut = function (e) {
              t.prototype.animateOut.call(this, e),
                (this.timelineOut = new TimelineMax({
                  ...
                  .to("#main-loading__overlay", 0.8, { opacity: 0 }, 0)
                  .to(
                    "#main-loading__outer",
                    0.8,
                    { yPercent: -100, ease: Expo.easeInOut },
            ...
            (e.prototype.onProgressTweenUpdate = function () {
              var t =
                1 === this.progress
                  ? "100"
                  : ("0" + parseInt(100 * this.progress)).slice(-2);
      ...
      { "lib/DrawSVGPlugin": 10, "screen-navigator": 81 },
    ],
    28: [
      function (t, e, i) {
        "use strict";
            ...
            return (
              ...
              (e.prototype.disposeTimelineIn = function () {
                t.prototype.disposeTimelineIn.call(this),
                  this.splittedTitle &&
                    (this.splittedTitle.revert(), (this.splittedTitle = null));
              }),
              (e.prototype.populateTimelineIn = function () {
                t.prototype.populateTimelineIn.call(this);
                ...
                (this.splittedTitle = new p.default("#process__title", {
                  ...
                  this.timelineIn
                    .staggerFrom(
                      this.splittedTitle.lines,
                      0.7,
                      { y: 80, opacity: 0, ease: Expo.easeOut },
                      0.1,
                      0.2
                    )
                    .staggerFrom(
                      this.element.find(".process__intro__txt"),
                      0.7,
                      { y: 80, opacity: 0, ease: Expo.easeOut },
                      0.1,
                      0.4
                ...
                for (var i = 0, n = e.length; i < n; i++) {
                  ...
                  if (
                    ...
                    break;
                  this.timelineIn.staggerFrom(
                    [
                      s.querySelector(".process__step__index"),
                      s.querySelector(".process__step__title"),
                      s.querySelector(".process__step__body"),
                      s.querySelector(".process__step__img"),
                    ],
                    0.7,
                    { opacity: 0, y: 80, ease: Expo.easeOut },
                    0.05,
                    "-=.5"
                  );
                }
      ...
      { "lib/SplitText": 12, "pages/BasePage": 24 },
    ],
    29: [
      function (t, e, i) {
        "use strict";
          ...
          b = (function (t) {
            ...
            return (
              ...
              (e.prototype.initPage = function () {
                t.prototype.initPage.call(this),
                  (this.window = $(window)),
                  (this.firstProjectId = this.element[0].getAttribute(
              ...
              (e.prototype.initNav = function () {
                (this.nav = new u.default()),
                  this.nav.on(
                    "projectClick",
                    this.onNavProjectClick.bind(this)
                  ),
              ...
              (e.prototype.initProjectNavigator = function () {
                ...
                (this.projectNavigator = new p.default()),
                  (this.projectNavigator.transition = h.Transitions.outAndIn),
                  this.projectNavigator.on(
                    "transitionStart",
                    this.onProjectNavigatorTransitionStart.bind(this)
                  ),
                  e.each(function (e, i) {
              ...
              (e.prototype.initScrollCTA = function () {
                (this.scrollCTA = new _.default()),
                  this.scrollCTA.on("click", this.onScrollCTAClick.bind(this));
              }),
              (e.prototype.dispose = function () {
                t.prototype.dispose.call(this),
                  this.initialized &&
                    (this.nav.off("linkClick"),
                    this.nav.off("expanded"),
                    this.nav.dispose(),
                    (this.nav = null),
                    this.window.off("keyup." + this.uid),
                    (this.window = null),
                    this.element.off("DOMMouseScroll mousewheel"),
                    this.projectNavigator.off("transitionStart"),
              ...
              (e.prototype.resize = function (e) {
                t.prototype.resize.call(this, e),
                  this.projectNavigator &&
                    this.projectNavigator.currentScreen &&
                    this.projectNavigator.currentScreen.resize(e),
                  ...
                  app.windowWidth >= app.screenM
                    ...
                    : (TweenMax.set(this.line, {
                      ...
                      this.emit("updateRequest", {
                        logo: { color: this.nav.isExpanded ? "dark" : "light" },
                        "nav-toggle": {
              ...
              (e.prototype.populateTimelineIn = function () {
                ...
                this.scrollCTA.animateIn(),
                  this.timelineIn
                    .staggerFrom(
                      this.element.find(
                        ".projects__nav__index__txt, #projects__nav__expand"
                      ),
                      0.7,
                      { x: 20, opacity: 0, ease: Expo.easeOut },
                      0.1,
                      0.1
                    )
                    .from(
                      this.element.find(".projects__nav__index__txt"),
                      0.7,
                      { x: 20, opacity: 0, ease: Expo.easeOut },
                      0.1,
                      0.1
                    ...
                    .set(i, { x: -n.right, scaleX: n.height / n.width }, 0)
                    .add("tags", 0.2)
                    .to(i, 0.7, { x: n.width, ease: Expo.easeOut }, "tags")
                    .to(
                      i,
                      0.7,
                      { x: 0, scaleX: 1, ease: Expo.easeInOut },
                      "tags+=.6"
                    )
                    .staggerFrom(
                      e.element.find(".project__tag"),
                      0.7,
                      { y: 30, opacity: 0, ease: Expo.easeOut },
                      0.07,
                      "tags+=1"
                    )
                    .set(
                    ...
                    .to(o, 0.7, { scaleY: 0, ease: Expo.easeInOut }, 0.8)
                    .from(
                      e.media.navigator.currentScreen.element,
                      1.3,
                      { scale: 1.3, ease: Quart.easeOut },
                      0.8
                    )
                    .from(e.media.nav.element, 1.3, { opacity: 0 }, 1)
                    .add(this.scrollCTA.timelineIn, "-=.8");
              }),
              (e.prototype.populateLoader = function () {
                var e = this;
                t.prototype.populateLoader.call(this),
              ...
              (e.prototype.gotoProject = function (t, e) {
                if (!(t < 0 || t > this.projects.length - 1)) {
                  var i =
                      this.projectNavigator.currentScreen.index > t ? -1 : 1,
                    n = this.projects[t].id;
                  if (
                    n !== this.projectNavigator.currentScreen.id &&
                    (this.projectNavigator.currentScreen &&
                      (this.projectNavigator.currentScreen.direction = i),
                    this.projectNavigator.showScreen(n, null, {
                      properties: { direction: i },
                    }),
                    !e || !e.isPopState)
                  ) {
                    var s = this.nav.getProjectLink(n);
                    this.emit("pushState", { projectId: n, href: s }, s);
                  }
                }
              }),
              ...
              (e.prototype.onPopState = function (e) {
                if ((t.prototype.onPopState.call(this, e), e.state.href)) {
                  this.pathRegexp ||
                    ((this.pathRegexp = (0, v.default)("/project/:id?")),
                    (this.pathParser = document.createElement("a"))),
                  ...
                  if (i) {
                    ...
                    this.gotoProject(s, { isPopState: !0 });
                  }
                }
              }),
              (e.prototype.onScroll = function (t) {
                t.preventDefault(),
                  t.stopPropagation(),
                  this.projectNavigator.transitionRunning ||
                    this.projectNavigator.currentScreen.media.isFullscreen ||
                    ((t.originalEvent.wheelDelta &&
                      t.originalEvent.wheelDelta < 0) ||
                    (t.originalEvent.detail && t.originalEvent.detail > 0)
              ...
              (e.prototype.onProjectNavigatorTransitionStart = function () {
                var t =
                  this.projectNavigator.currentScreen.index ===
              ...
              (e.prototype.onNavExpanded = function (t) {
                app.windowWidth >= app.screenM ||
                  (TweenMax.killTweensOf(this.line),
                  TweenMax.to(this.line, 0.4, { autoAlpha: t ? 0 : 1 }),
                  this.emit("updateRequest", {
                    logo: { color: t ? "dark" : "light" },
                    "nav-toggle": { color: t ? "dark" : "light" },
                  }));
              }),
              e
            );
        ...
        var a = t("pages/BasePage"),
          ...
          m = (function (t) {
            ...
            return (
              ...
              (e.prototype.initPage = function () {
                t.prototype.initPage.call(this),
                  (this.headerImgWrapper = this.element.find(
                    "#solutions__header__img-wrapper"
                  )),
                  (this.headerImg = this.element.find(
              ...
              (e.prototype.initIndustries = function () {
                (this.industriesItems = this.element
                  .find(".solutions__industries__item")
                  .on("mouseenter", this.onIndustriesItemRollOver.bind(this))),
                  this.selectIndustriesItem(this.industriesItems[0]);
              }),
              (e.prototype.initScroll = function () {
                (this.priceSquare = this.element.find(
                  "#solutions__price__images__square"
                )),
                  (this.priceImg1 = this.element.find(
                    "#solutions__price__img-1"
                  )),
                  (this.expertsBg = this.element.find(
              ...
              (e.prototype.initMaterial = function () {
                (this.materialSelect = this.element
                  .find("#solutions__material__select__input")
                  .on("change", this.onMaterialSelectChange.bind(this))),
                  (this.downloadBtnEnabled = !1),
                  (this.downloadBtn = this.element
                    .find("#solutions__material__download")
                    .on("click", this.onDownloadBtnClick.bind(this)));
              }),
              (e.prototype.dispose = function () {
                t.prototype.dispose.call(this),
                  this.initialized &&
                    (this.stopTicker(),
                    this.window.off("scroll." + this.uid),
                    this.industriesItems.off("hover"),
                    this.materialSelect.off("change"),
                    this.downloadBtn.off("click"));
              }),
              (e.prototype.resize = function (e) {
                t.prototype.resize.call(this, e),
                  this.resizeHeaderImg(),
                  app.windowWidth < app.screenM ||
                    (this.resizeScroll(), this.renderScroll());
              }),
              (e.prototype.resizeHeaderImg = function () {
                var t = this.headerImg[0].naturalWidth,
                  ...
                  a = Math.ceil(t * r),
                  l = Math.ceil(e * r),
                  h = Math.floor(-0.5 * (a - i)),
                  p = Math.floor(-0.5 * (l - n));
                this.headerImg.css({ left: h, top: p, width: a, height: l });
              }),
              (e.prototype.resizeScroll = function () {
                ...
                (this.priceSquareScrollTopEnd =
                  i.top +
                  window.pageYOffset -
                  app.windowHeight +
                  i.height +
                  100),
                  (this.priceSquareYStart =
                    e.top +
                    window.pageYOffset -
                    (i.top + window.pageYOffset) -
                    50),
                  (this.priceSquareScaleYEnd =
                    i.height / this.priceSquare.height()),
                  (this.expertsBgScrollTopEnd =
                    r.top + window.pageYOffset - app.windowHeight + 200),
                  (this.expertsBgYStart =
                    e.top +
                    window.pageYOffset -
              ...
              (e.prototype.renderScroll = function () {
                ...
                if (this.priceSquareIsActive) {
                  (this.priceSquareScrollTop +=
                    0.1 * (this.scrollTop - this.priceSquareScrollTop)),
                    (this.priceSquareScrollTopProgress =
                      this.priceSquareScrollTop / this.priceSquareScrollTopEnd),
                    this.priceSquareScrollTopProgress > 1 &&
                      (this.priceSquareScrollTopProgress = 1);
                  var e =
                      this.priceSquareYStart *
                      (1 - this.priceSquareScrollTopProgress),
                    i =
                      this.priceSquareScaleYStart +
                      (this.priceSquareScaleYEnd -
                        this.priceSquareScaleYStart) *
                        this.priceSquareScrollTopProgress;
                  this.priceSquare[0].style[this.transformProperty] =
                    "translate3d(0," + e + "px,0) scaleY(" + i + ")";
                  (t =
                    Math.abs(
                      this.priceSquareScrollTopProgress -
                        this.priceSquareScrollTopProgressOld
                    ) > 0.001),
                    (this.priceSquareScrollTopProgressOld =
                      this.priceSquareScrollTopProgress),
                    this.priceSquareScrollTopProgress > 0.999 &&
                      ((this.priceSquareIsActive = !1), this.showPriceImg());
                }
                if (this.expertsBgIsActive) {
                  (this.expertsBgScrollTop +=
                    0.1 * (this.scrollTop - this.expertsBgScrollTop)),
                    (this.expertsBgScrollTopProgress =
                      this.expertsBgScrollTop / this.expertsBgScrollTopEnd),
                    this.expertsBgScrollTopProgress > 1 &&
                      (this.expertsBgScrollTopProgress = 1);
                  var e =
                    (this.expertsBgYStart - 80) *
                    (1 - this.expertsBgScrollTopProgress);
                  this.expertsBg[0].style[this.transformProperty] =
                    "translate3d(" +
                    this.expertsBgX +
                    "px," +
                    e +
                    "px,0) scale(" +
                    this.expertsBgScaleX +
                    "," +
                    this.expertsBgScaleY +
                    ")";
                  (t =
                    Math.abs(
                      this.expertsBgScrollTopProgress -
                        this.expertsBgScrollTopProgressOld
                    ) > 0.001),
                    (this.expertsBgScrollTopProgressOld =
                      this.expertsBgScrollTopProgress),
                    this.expertsBgScrollTopProgress > 0.999 &&
                      ((this.expertsBgIsActive = !1), this.showExperts());
                }
                t || (this.scrollIsSleeping = !0);
              }),
              (e.prototype.showPriceImg = function () {
                ...
                new TimelineMax()
                  .to(t, 0.7, { scaleX: 0, ease: Expo.easeInOut })
                  .from(i, 2, { scale: 1.3, ease: Quart.easeOut }, 0)
                  .to(e, 0.7, { scaleX: 0, ease: Expo.easeInOut }, 0.5)
                  .from(n, 2, { scale: 1.3, ease: Quart.easeOut }, 0.5);
              }),
              (e.prototype.showExperts = function () {
                new TimelineMax()
                  .to(
                    this.expertsBg,
                    0.9,
                    { x: 0, scale: 1, ease: Expo.easeInOut },
                    0
                  )
                  .fromTo(
                    [
              ...
              (e.prototype.populateTimelineIn = function () {
                ...
                (this.splittedSubtitle = new d.default("#solutions__subtitle", {
                  ...
                  (this.splittedIntroTitle = new d.default(
                ...
                var s = new TimelineMax()
                  ...
                  .to(e, 0.4, { scaleX: 1, ease: Quart.easeInOut }, "-=.3")
                  .to(
                    e,
                    0.7,
                    { y: 0, scaleY: 1, ease: Expo.easeInOut },
                    "-=.2"
                  );
                this.timelineIn
                  .add(s, 0)
                  ...
                  .staggerFrom(
                    ["#solutions__title"].concat(this.splittedSubtitle.lines),
                    0.7,
                  ...
                  .staggerFrom(
                    ["#solutions__intro__body"].concat(
                      this.splittedIntroTitle.lines.reverse()
                    ),
                    0.7,
                    { y: -30, opacity: 0, ease: Expo.easeOut },
                    0.1,
              ...
              (e.prototype.onAnimateInComplete = function () {
                t.prototype.onAnimateInComplete.call(this),
                  this.splittedSubtitle &&
                    (this.splittedSubtitle.revert(),
                    (this.splittedSubtitle = null)),
                  this.splittedIntroTitle &&
                    (this.splittedIntroTitle.revert(),
                    (this.splittedIntroTitle = null));
              }),
              (e.prototype.onFrame = function () {
                if (this.scrollIsSleeping) return void (this.isTicking = !1);
              ...
              (e.prototype.onMaterialSelectChange = function (t) {
                ...
                this.downloadBtnEnabled ||
                  ((this.downloadBtnEnabled = !0),
                  this.downloadBtn.removeClass(
              ...
              (e.prototype.onDownloadBtnClick = function (t) {
                -1 !==
                  t.currentTarget.className.indexOf(
                    "solutions__material__download--disabled"
                  ) && t.preventDefault();
              }),
              e
        ...
        var s = (function () {
          function t(e) {
            n(this, t),
              ...
              (this.subjects = this.element
                .find(".contact__form__subject__item input")
                .on("change", this.onSubjectChange.bind(this))),
              (this.jobs = this.element
                .find("#contact__form__jobs")
                .height($("#contact__form__jobs").outerHeight())
                .addClass("contact__form__jobs--hidden")),
              (this.jobsSelect = this.element
                .find("#contact__form__jobs__select")
                .on("change", this.onJobsSelectChange.bind(this))),
              (this.jobDetailBtn = this.element
                .find("#contact__form__jobs__detail")
                .css("display", "none")
                .on("click", this.onJobDetailBtnClick.bind(this))),
              (this.fileInput = this.element
                .find("#contact__form__file__input")
                .on("change", this.onFileInputChange.bind(this))),
              $(".contact__form__edu, #contact__form__org").attr(
                "disabled",
                !0
              ),
              (this.fileLabel = this.element.find(
              ...
              (this.addEducationBtn = this.element
                .find("#contact__form__edu__add")
                .on("click", this.onAddEducationBtnClick.bind(this))),
              this.element.on(
                "click",
                ".contact__form__edu__remove",
                this.onRemoveEducationBtnClick.bind(this)
              );
          }
          return (
            ...
            (t.prototype.reset = function () {
              this.element
                .trigger("reset")
                .removeClass(
                  "contact__form--success contact__form--fail contact__form--sending"
                ),
            ...
            (t.prototype.selectSubject = function (t) {
              this.element
                .find('.contact__form__subject__item input[value="' + t + '"]')
                .prop("checked", !0)
                .trigger("change");
            }),
            ...
            (t.prototype.onSubjectChange = function (t) {
              ...
              this.currentSubject &&
                this.element.removeClass(
                  "contact__form--" + this.currentSubject
                ),
                (this.currentSubject = e),
                this.element.addClass("contact__form--" + e),
                this.jobs.toggleClass("contact__form__jobs--hidden", !i),
                $("#contact__form__edu, #contact__form__org")
                  .css("display", i ? "block" : "")
                  .attr("disabled", !i),
                $(
                  "#contact__form__name__personal, #contact__form__name__company"
                ).attr("disabled", "job" === e),
                $(
                  "#contact__form__name__last, #contact__form__name__first"
                ).attr("disabled", "job" !== e),
            ...
            (t.prototype.onFileInputChange = function (t) {
              ...
              (this.fileLabelTxt || i) &&
                (this.fileLabelTxt ||
                  (this.fileLabelTxt = this.fileLabel.text()),
                i &&
                  e.length > 20 &&
                  (e =
                    e.substr(0, 10) +
                    "..." +
                    e.substr(e.length - 10, e.length)),
                this.fileLabel.text(i ? e : this.fileLabelTxt));
            }),
            (t.prototype.onSubmit = function (t) {
              ...
              t.preventDefault(),
                this.element
                  .addClass("contact__form--sending")
                  .removeClass("contact__form--success contact__form--fail"),
            ...
            (t.prototype.onFormFail = function (t) {
              var e = $("<ul></ul>");
              if (
                (this.element.addClass("contact__form--fail"),
                t && t.responseJSON && t.responseJSON.errors)
              ) {
                t.responseJSON.errors.forEach(function (t, i) {
                  e.append("<li>" + t + "</li>");
                });
              } else
                e.append("<li>Something went worng, please try again.</li>");
              this.alert.html(e);
            }),
            ...
            (t.prototype.onAddEducationBtnClick = function (t) {
              ...
              r.attr("id", l),
                a.attr("for", l),
                i
                  .find(".contact__form__edu__graduate input")
                  .attr("name", "graduate[" + e.length + "]")
                  .prop("checked", !1),
                i.find(":input").val(""),
    ...
    32: [
          ...
          h = (function (t) {
            ...
            return (
              ...
              (e.prototype.disposeTimelineIn = function () {
                this.timelineIn &&
                  (this.timelineIn.kill(),
                  (0, l.default)(this.timelineIn),
                  (this.timelineIn = null));
              }),
              (e.prototype.disposeTimelineOut = function () {
                this.timelineOut &&
                  (this.timelineOut.kill(),
                  (0, l.default)(this.timelineOut),
              ...
              (e.prototype.complete = function () {
                this.emit("complete", {
                  id: this.id,
                  index: this.index,
                  step: this.stepNavigator
                    ? this.stepNavigator.currentScreen.id
                    : null,
                });
              }),
              (e.prototype.animateIn = function (e) {
                if ((t.prototype.animateIn.call(this, e), e))
                  return void this.timelineIn.kill();
                (this.isVisible = !0),
                  this.init(),
                  (this.timelineIn = new TimelineMax({
                    onStart: this.onAnimateInStart.bind(this),
              ...
              (e.prototype.populateTimelineIn = function () {}),
              (e.prototype.animateOut = function (e) {
                if ((t.prototype.animateOut.call(this, e), e))
                  return (
                    this.disposeTimelineOut(), void this.onAnimateOutComplete()
                  );
                (this.timelineOut = new TimelineMax({
              ...
              (e.prototype.onAnimateInStart = function () {
                ...
                if (this.owner.previousScreen) {
                  2 === this.owner.previousScreen.element[0].style.zIndex &&
                    (t = 1);
                }
                (this.element[0].style.visibility = "inherit"),
              ...
              (e.prototype.onAnimateOutStart = function () {
                ...
                if (e) {
                  var i = "landing" === e.id,
                    ...
                    s =
                      this.stepNavigator &&
                      this.stepNavigator.previousScreen &&
                      "step-2" === this.stepNavigator.previousScreen.id,
      ...
      { "anim/gsap/clear-timeline": 2, "screen-navigator": 81 },
    ],
    33: [
      function (t, e, i) {
        "use strict";
            ...
            return (
              ...
              (e.prototype.init = function () {
                t.prototype.init.call(this),
                  (this.scrollBtn = $("#home-landing__scroll").on(
                    "click",
                    this.onScrollBtnClick.bind(this)
                  )),
                  (this.ctaBtn = $("#home-landing__content__cta").on(
                    "click",
                    this.onCtaBtnClick.bind(this)
                  )),
                  (this.video = $("#home-landing__bg__video")),
                  app.hasTouch &&
                    ((this.hammer = new u.default.Manager(this.element[0], {
                      recognizers: [
                        [
                          u.default.Swipe,
              ...
              (e.prototype.dispose = function () {
                t.prototype.dispose.call(this),
                  this.initialized &&
                    ...
                    this.ctaBtn.off("click"),
                    this.hammer &&
                      (this.hammer.destroy(), (this.hammer = null)),
                    this.video.off("canplaythrough." + this.uid));
              }),
              (e.prototype.disposeTimelineIn = function () {
                t.prototype.disposeTimelineIn.call(this),
                  this.splittedTitle &&
              ...
              (e.prototype.populateTimelineIn = function () {
                ...
                (this.splittedTitle = new p.default(o, { type: "lines" })),
                  this.timelineIn
                    .set(this.element, { pointerEvents: "none" }, 0)
                    .add(function () {
                      e.video.length && e.video[0].play();
                    }, 0.1)
                    .from(i[0], 0.8, { scaleY: 0, ease: Quad.easeInOut }, 0)
                    .from(i[1], 0.7, { scaleY: 0, ease: Quad.easeInOut }, 0)
                    .from(i[2], 0.8, { scaleY: 0, ease: Quad.easeInOut }, 0.3)
                    .set(n, { scaleX: 4.4, autoAlpha: 0 }, 0)
                    .fromTo(
                      n,
                      0.8,
                      { xPercent: -440, autoAlpha: 1 },
                      { xPercent: 0, immediateRender: !1, ease: Expo.easeOut },
                      0.5
                    )
                    .addLabel("text-bg", 0.5)
                    .fromTo(
                      s,
                      0.9,
                      { xPercent: -100 },
                      { xPercent: 10, ease: Expo.easeOut },
                      "text-bg"
                    )
                    .fromTo(
                      s,
                      0.8,
                      { scaleX: r },
                      { scaleX: 1, xPercent: 0, ease: Expo.easeInOut },
                      "text-bg+=.5"
                    )
                    .staggerFrom(
                      [
                        "#home-landing__content__text__heading__baseline",
                      ].concat(this.splittedTitle.lines),
                      0.9,
      ...
      { hammerjs: 71, "lib/SplitText": 12, "pages/home/AHomeScreen": 32 },
    ],
    34: [
      function (t, e, i) {
        "use strict";
          ...
          m = (function (t) {
            ...
            return (
              ...
              (e.prototype.initStepNavigator = function () {
                ...
                (this.stepNavigator = new p.default()),
                  ...
                  e.forEach(function (e, i) {
                    ...
                    t.stepNavigator.addItem(s, e, {
                      arguments: [
                        { screen: t, id: s, index: n, owner: t.stepNavigator },
                      ],
                      events: {
              ...
              (e.prototype.resize = function (e) {
                t.prototype.resize.call(this, e),
                  this.stepNavigator &&
                    this.stepNavigator.currentScreen &&
                    this.stepNavigator.currentScreen.resize(e);
              }),
              (e.prototype.gotoNextStep = function () {
                this.stepNavigator.transitionRunning ||
                  ("step-1" === this.stepNavigator.currentScreen.id
                    ? this.stepNavigator.showScreen("step-2")
                    : this.complete());
              }),
              (e.prototype.gotoPrevStep = function () {
                this.stepNavigator.transitionRunning ||
                  ("step-2" === this.stepNavigator.currentScreen.id
                    ? this.stepNavigator.showScreen("step-1")
                    : this.complete());
              }),
              (e.prototype.animateIn = function (e) {
                t.prototype.animateIn.call(this, e);
              ...
              (e.prototype.populateTimelineIn = function () {
                ...
                var e =
                  this.firstStepId ||
                  "step-" + (1 === this.direction ? "1" : "2");
                if (
                  null === this.owner.previousItemId &&
                  app.debug &&
                  app.urlQuery.step
                ) {
                ...
                this.stepNavigator.showScreen(e),
                  this.timelineIn.add(
                    this.stepNavigator.currentScreen.timelineIn
                  );
              }),
              (e.prototype.populateTimelineOut = function () {
                t.prototype.populateTimelineOut.call(this),
                  ...
                  this.timelineOut.add(
                    this.stepNavigator.previousScreen.timelineOut
                  );
              }),
    ...
    35: [
        ...
        var l = (function (t) {
          ...
          return (
            ...
            (e.prototype.animateIn = function () {
              this.timelineIn = new TimelineMax({
                ...
                .from(
                  "#home-pagination",
                  1,
                  { y: 60, autoAlpha: 0, ease: Expo.easeOut },
                  0.3
                )
                .staggerFrom(
                  ".home-pagination__nav__item",
                  0.8,
                  { y: 40, autoAlpha: 0, ease: Expo.easeOut },
                  0.05,
                  "-=.7"
                );
            }),
            ...
            (e.prototype.updateSize = function (t) {
              ...
              if (t && t !== this.size) {
                ...
                if (
                  ...
                  new TimelineMax({
                    onComplete: function () {
                      TweenMax.set(e.element, { clearProps: "y" }),
                        TweenMax.set(e.number, { clearProps: "scale, y, x" }),
                        TweenMax.set(e.nav, { clearProps: "y" }),
                    ...
                    .to(
                      ...
                      0.7,
                      {
                        x: parseInt(0.5 * (n - this.number.width())),
                        y: parseInt(
                          this.number[0].offsetTop + this.number.height() - s
                        ),
                        scale: a,
                        ease: Quart.easeInOut,
                      },
              ...
              if (t !== this.currentIndex) {
                (this.currentIndex = t),
                  ...
                  this.navItems.removeClass(
                    "home-pagination__nav__item--selected"
                  ),
                  $(this.navItems[this.currentIndex - 1]).addClass(
                    "home-pagination__nav__item--selected"
                  );
              }
            }),
            (e.prototype.startTimer = function (t) {
              this.timerIsRunning ||
                ((this.timerItemIndex = t - 1),
                (this.timerIsRunning = !0),
                (this.timerElement = $(this.navItems[this.timerItemIndex]).find(
                  ".home-pagination__nav__item__timer"
                )),
                (this.timerTimeline = new TimelineMax({
                  onComplete: this.onTimerComplete.bind(this),
                })
                  .to(
                    this.navBtns[this.timerItemIndex],
                    0.5,
                    { scale: 3, autoAlpha: 0, ease: Expo.easeOut },
                    0
                  )
                  .fromTo(
                    this.timerElement,
                    ...
                    { scale: 1, autoAlpha: 1, ease: Expo.easeOut },
                    0
                  )
                  .fromTo(
                    this.timerElement.find(
                      ".home-pagination__nav__item__timer__progress"
                    ),
                    7,
                    { drawSVG: "0" },
            ...
            (e.prototype.stopTimer = function (t) {
              this.timerIsRunning &&
                t - 1 === this.timerItemIndex &&
                ((this.timerIsRunning = !1),
                this.timerTimeline.kill(),
                (this.timerTimeline = null),
                TweenMax.to(this.timerElement, 0.3, {
                  scale: 0.2,
                  autoAlpha: 0,
                  ease: Quart.easeInOut,
                }),
                TweenMax.to(this.navBtns[this.timerItemIndex], 0.3, {
                  scale: 1,
                  autoAlpha: 1,
                  ease: Quart.easeInOut,
                }),
      ...
      { "lib/DrawSVGPlugin": 10, "tiny-emitter": 102 },
    ],
    36: [
      function (t, e, i) {
        "use strict";
        ...
        var a = t("tiny-emitter"),
          ...
          u = (function (t) {
            function e() {
              ...
              var i = o(this, t.call(this));
              return (
                (i.element = $("#home-scroll-cta")),
                (i.isVisible = !1),
                (i.color = null),
                (i.btn = $("#home-scroll-cta__btn").on(
                  "click",
                  i.onBtnClick.bind(i)
                )),
                ...
                (i.timelineOut = null),
                app.hasTouch &&
                  ((i.hammer = new c.default.Manager(i.element[0], {
                    recognizers: [
                      [
                        c.default.Swipe,
            ...
            return (
              ...
              (e.prototype.disposeTimelineReverse = function () {
                this.timelineReverse &&
                  (this.timelineReverse.kill(), (this.timelineReverse = null));
              }),
              (e.prototype.show = function () {
                this.isVisible ||
                  ((this.isVisible = !0),
              ...
              (e.prototype.animateIn = function () {
                this.timelineIn = new TimelineMax({
                  ...
                  [this.btn, this.label],
                  0.9,
                  { y: -110, autoAlpha: 0, ease: Expo.easeOut },
                  0.1,
                  0.5
                );
              }),
                  ...
                  (this.isReversed = t),
                    ...
                    this.isReversed
                      ? (this.originalLabel ||
                        ...
                        (i = this.label.attr("data-reverse")))
                      : this.originalLabel && (i = this.originalLabel),
                    (this.timelineReverse = new TimelineMax({
                      onComplete: this.onTimelineReverseComplete.bind(this),
                    })),
                    this.isVisible &&
                      this.timelineReverse
                        .to(this.label, 0.5, { opacity: 0 })
                        .to(this.btn, 0.5, { opacity: 0 }, 0),
                    this.timelineReverse
                      .add(function () {
                        i && e.label.text(i);
                      })
                      .set(this.btn, { rotation: this.isReversed ? -180 : 0 }),
                    this.isVisible &&
                      this.timelineReverse
                        .add("show")
                        .to(this.label, 0.5, { opacity: 1 }, "show")
                        .fromTo(
                          this.btn,
                          0.5,
                          { opacity: 0, y: 30, immediateRender: !1 },
      ...
      { "anim/gsap/clear-timeline": 2, hammerjs: 71, "tiny-emitter": 102 },
    ],
    37: [
      function (t, e, i) {
        "use strict";
          ...
          h = (function (t) {
            function e(i) {
              ...
              return (
                ...
                (o.owner = i.owner),
                (o.initialized = !1),
                (o.element = o.screen.element.find(
                  ".home-screen__step-" + o.index
                )),
                (o.timelineIn = null),
                (o.timelineInVars = {
            ...
            return (
              ...
              (e.prototype.disposeTransition = function () {
                this.transition &&
                  (this.transition.dispose(), (this.transition = null));
              }),
              (e.prototype.resize = function (t) {
              ...
              (e.prototype.getElementsToUpdate = function () {
                return {
                  logo: { color: "step-1" === this.id ? "light" : "dark" },
                  "nav-toggle": {
              ...
              (e.prototype.onAnimateInComplete = function () {
                this.disposeTimelineIn(),
                  this.emit("animateInComplete", { id: this.id });
              }),
              (e.prototype.onAnimateOutStart = function () {
                this.emit("animateOutStart", { id: this.id });
              }),
              (e.prototype.onAnimateOutComplete = function () {
                t.prototype.onAnimateOutComplete.call(this);
              }),
        ...
        var a = t("pages/home/screen-steps/AScreenStep"),
          ...
          v = (function (t) {
            function e(i) {
              s(this, e);
              var n = o(this, t.call(this, i));
              return (n.timelineInVars.delay = 0.6), n;
            }
            return (
              r(e, t),
              (e.prototype.init = function () {
                switch (
                  (t.prototype.init.call(this),
                  (this.video = this.element.find(
                    ".home-screen__step-1__bg__video"
                  )),
                  (this.canvas = this.element.find(
                    ".home-screen__step-1__bg__canvas"
                  )),
                  (this.context = this.canvas[0].getContext("2d")),
                  (this.buffer = document.createElement("canvas")),
                  (this.bufferContext = this.buffer.getContext("2d")),
                  (this.hasVideo = this.video.length > 0),
                  (this.mediaLoader = null),
                  (this.media = this.video[0]),
                  this.media ||
                    ((this.mediaLoader = d.default.getItem(
                      "home",
                      "screen-" + this.screen.index + "-step-1"
                    )),
                    (this.media = this.mediaLoader.img)),
                  (this.mediaWidth = 0),
                  (this.mediaHeight = 0),
                ...
                app.hasTouch &&
                  ((this.hammer = new _.default.Manager(this.element[0], {
                    recognizers: [
                      [
                        _.default.Swipe,
              ...
              (e.prototype.resizeCanvas = function () {
                (this.canvas[0].width = this.buffer.width = app.windowWidth),
                  (this.canvas[0].height = this.buffer.height =
                    app.windowHeight);
              }),
              (e.prototype.startTicker = function () {
                this.isTicking ||
              ...
              (e.prototype.render = function () {
                var t = app.windowWidth / this.mediaWidth,
                  ...
                  o = parseInt(-0.5 * (n - app.windowWidth)),
                  r = parseInt(-0.5 * (s - app.windowHeight)),
                  a = [
                    this.media,
                    0,
                    0,
                ...
                this.transition
                  ? this.transition.render(a)
                  : (this.mediaNeedsUpdate &&
                      (this.bufferContext.drawImage.apply(
                        this.bufferContext,
                        a
                      ),
                      this.context.drawImage(this.buffer, 0, 0)),
                    this.hasVideo || (this.mediaNeedsUpdate = !1));
              }),
              (e.prototype.animateIn = function () {
              ...
              (e.prototype.populateTimelineIn = function () {
                ...
                (this.splittedSubtitle = new u.default(i, { type: "lines" })),
                  ...
                  this.timelineIn
                    .add(this.transition.timeline, 0)
                    .from(n[0], 0.9, { scaleY: 0, ease: Expo.easeInOut }, 0)
                    .from(n[1], 1.2, { scaleY: 0, ease: Expo.easeInOut }, 0)
                    .staggerFrom(
                      [e].concat(this.splittedSubtitle.lines),
                      0.7,
                      { y: 50, opacity: 0, ease: Expo.easeOut },
                      0.06,
                      0.4
              ...
              (e.prototype.populateTimelineOut = function () {
                ...
                var e = this.element.find(
                  ...
                  n = this.screen.element.find(
                    ".home-screen__step-2__content__inner__title"
                  ),
                  s = this.screen.element.find(
                ...
                (this.transition = new this.transitionOutClass({
                  ...
                  this.owner.currentScreen
                    ...
                    : this.timelineOut.to([e, i, h], 0.7, { opacity: 0 }, 0.4);
              }),
              (e.prototype.onAnimateInComplete = function () {
                t.prototype.onAnimateInComplete.call(this),
                  this.splittedSubtitle &&
              ...
              (e.prototype.onAnimateOutComplete = function () {
                t.prototype.onAnimateOutComplete.call(this),
                  this.stopTicker(),
                  this.hasVideo &&
                    ((this.video[0].currentTime = 0), this.video[0].pause());
              }),
          ...
          m = (function (t) {
            ...
            return (
              ...
              (e.prototype.init = function () {
                ...
                if (app.hasTouch) {
                  var i = [
                    this.element.find(".home-screen__step-2__bg")[0],
                    this.element.find(".home-screen__step-2__img")[0],
                    this.element.find(".home-screen__step-2__corner")[0],
                  ];
                  (this.hammers = []),
              ...
              (e.prototype.dispose = function () {
                t.prototype.dispose.call(this),
                  this.initialized &&
                    this.hammers &&
                    (this.hammers.forEach(function (t, e) {
                      t.destroy();
                    }),
                    (this.hammers = null));
              }),
          ...
          c = (function (t) {
            function e(i) {
              ...
              return (
                (n.canvas = i.canvas),
                (n.context = i.context),
                (n.boxLeft = new p.default()),
                (n.boxRight = new p.default()),
                (n.videoLeft = new p.default()),
                (n.videoLeft.scale = 1),
                (n.videoRight = new p.default()),
            ...
            return (
                ...
                t.prototype.populateTimeline.call(this),
                  this.timeline
                    .from(
                      this.boxLeft,
                      0.8,
                      { y: app.windowHeight, ease: Expo.easeOut },
                      0
                    )
                    .from(
                      this.boxRight,
                    ...
                    .from(
                      this.videoLeft,
                      0.8,
                      { y: app.windowHeight, scale: 1.2, ease: Expo.easeOut },
                      0.2
                    )
                    .from(
                      this.videoRight,
              ...
              (e.prototype.resize = function () {
                t.prototype.resize.call(this),
                  (this.boxLeft.width = this.videoLeft.width =
                    Math.ceil(0.5 * app.windowWidth)),
                  (this.boxLeft.height = this.videoLeft.height =
                    app.windowHeight),
                  (this.boxRight.x = this.videoRight.x =
                    Math.ceil(0.5 * app.windowWidth)),
                  (this.boxRight.width = this.videoRight.width =
                    Math.floor(0.5 * app.windowWidth)),
                  (this.boxRight.height = this.videoRight.height =
                    app.windowHeight),
              ...
              (e.prototype.render = function (t) {
                ...
                (this.context.fillStyle = "#fff"),
                  ...
                  this.context.fillRect(
                    ...
                    this.boxRight.y,
                    this.boxRight.width,
                    this.boxRight.height
                  ),
                  this.bufferContext.drawImage.apply(this.bufferContext, t),
                  (e =
                    this.videoLeft.x +
                    0.5 *
                      (this.videoLeft.width -
                        this.videoLeft.width * (1 / this.videoLeft.scale))),
                  (i =
                    this.videoLeft.y +
                    0.5 *
                      (this.videoLeft.height -
                        this.videoLeft.height * (1 / this.videoLeft.scale))),
                  (n = this.videoLeft.width * (1 / this.videoLeft.scale)),
                  (s =
                    (this.videoLeft.height - i) * (1 / this.videoLeft.scale)),
                  0 === s && (s = 1e-4),
                  (o = this.videoLeft.x),
                  (r = this.videoLeft.y),
                  ...
                  (e =
                    this.videoRight.x +
                    0.5 *
                      (this.videoRight.width -
                        this.videoRight.width * (1 / this.videoRight.scale))),
                  (i =
                    0.5 *
                    (this.videoRight.height -
                      this.videoRight.height * (1 / this.videoRight.scale))),
                  (n = this.videoRight.width * (1 / this.videoRight.scale)),
                  (s =
                    (this.videoRight.height + this.videoRight.y) *
                    (1 / this.videoRight.scale)),
                  0 === s && (s = 1e-4),
                  (o = this.videoRight.x),
                  (r = 0),
              ...
              (e.prototype.populateTimeline = function () {
                t.prototype.populateTimeline.call(this),
                  this.timeline.staggerFrom(
                    this.boxes,
                    0.8,
                    { x: app.windowWidth, ease: Expo.easeOut },
                    0.1
                  );
              }),
              (e.prototype.resize = function () {
                t.prototype.resize.call(this);
                for (
                  var e = Math.ceil(app.windowHeight / this.numBoxes), i = 0;
                  i < this.numBoxes;
                  i++
                ) {
                  var n = this.boxes[i];
                  (n.width = app.windowWidth),
                    (n.height = e),
                    (n.y = e * i),
                    n.y + n.height > app.windowHeight &&
                      (n.height = app.windowHeight - n.y);
                }
                (this.buffer.width = app.windowWidth),
                  (this.buffer.height = app.windowHeight);
              }),
        ...
        var a = t("pages/home/screen-steps/transitions/ATransition"),
          ...
          c = (function (t) {
            function e(i) {
              ...
              (n.canvas = i.canvas),
                (n.context = i.context),
                (n.overlay = new p.default());
              var r = parseInt(0.9 * app.windowWidth),
                a = parseInt(0.7 * app.windowHeight),
                l = parseInt(0.5 * (app.windowWidth - r)),
                h = parseInt(0.5 * (app.windowHeight - a));
              return (
                (n.mask = new p.default()),
                (n.mask.x = l),
                (n.mask.y = h),
                (n.mask.width = r),
                (n.mask.height = a),
                (n.maskPosition = new p.default()),
                (n.buffer = document.createElement("canvas")),
                (n.bufferContext = n.buffer.getContext("2d")),
                n
              );
                ...
                t.prototype.populateTimeline.call(this),
                  this.timeline
                    ...
                    .from(
                      this.maskPosition,
                      0.9,
                      { y: app.windowHeight, ease: Quart.easeInOut },
                      0.1
                    )
                    .to(
                      this.mask,
              ...
              (e.prototype.render = function (t) {
                this.bufferContext.drawImage.apply(this.bufferContext, t),
                  ...
                  this.context.drawImage(
                    ...
                    this.mask.height,
                    this.mask.x,
                    this.maskPosition.y + this.mask.y,
                    this.mask.width,
                    this.mask.height
                  );
              }),
        ...
        var a = t("pages/home/screen-steps/transitions/ATransition"),
          ...
          c = (function (t) {
            ...
            return (
              ...
              (e.prototype.populateTimeline = function () {
                t.prototype.populateTimeline.call(this);
                var e = parseInt(0.9 * app.windowWidth),
                  i = parseInt(0.7 * app.windowHeight),
                  n = parseInt(0.5 * (app.windowWidth - e)),
                  s = parseInt(0.5 * (app.windowHeight - i));
                this.timeline
                  .to(
                    this.mask,
                    0.8,
                    { x: n, y: s, width: e, height: i, ease: Expo.easeInOut },
                    0.1
                  )
                  .to(
                    this.position,
                    0.7,
                    { x: -(n + e + 10), ease: Expo.easeInOut },
                    "-=.2"
                  );
              }),
              (e.prototype.render = function (t) {
              ...
              (e.prototype.populateTimeline = function () {
                ...
                this.timeline
                  .to(
                    this.mask,
                    0.8,
                    { y: s, width: i, height: n, ease: Expo.easeInOut },
                    0.1
                  )
                  .to(
                    this.position,
                    0.7,
                    { x: -i, ease: Expo.easeInOut },
                    "-=.2"
                  );
              }),
              (e.prototype.render = function (t) {
            ...
            (function (t) {
              ...
              return (
                ...
                (e.prototype.populateTimeline = function () {
                  ...
                  this.timeline
                    .set(e, { zIndex: 2 }, 0)
                    .from(e, 0.7, { yPercent: 100, ease: Expo.easeInOut }, 0.2)
                    .from(
                      e,
                      0.7,
                      {
                        scaleX: 0.5,
                        x: 0.3 * app.windowWidth,
                    ...
                    .from(
                      this.element.find(".home-screen__step-2__bg"),
                      0.8,
                      { x: app.windowWidth, ease: Expo.easeInOut },
                      0.7
                    );
                }),
                e
              ...
              return (
                ...
                (e.prototype.populateTimeline = function () {
                  ...
                  this.timeline
                    ...
                    .from(
                      this.element.find(".home-screen__step-2__img"),
                      1.1,
                      { xPercent: 100, ease: Expo.easeOut },
                      0.7
                    )
                    .to(i, 0.8, { xPercent: -100, ease: Quart.easeInOut }, 0.7);
                }),
                e
              );
            })(l.default));
            ...
            (function (t) {
              ...
              return (
                ...
                (e.prototype.populateTimeline = function () {
                  ...
                  this.timeline
                    .set(i, { visibility: "inherit" })
                    .to(i, 0.8, { xPercent: 100, ease: Quart.easeInOut }, 0.6)
                    .from(e, 1.3, { scale: 1.1, ease: Quart.easeOut }, 0.6)
                    .from(n, 0.8, { yPercent: 100, ease: Expo.easeInOut }, 0.8);
                }),
                e
              );
            })(l.default));
                ...
                (e.prototype.populateTimeline = function () {
                  ...
                  this.timeline
                    .from(
                      e,
                      1.3,
                      { scale: 1.15, opacity: 0, ease: Quart.easeInOut },
                      0.4
                    )
                    .set(i, { zIndex: 2 }, 0)
                    .from(i, 0.8, { yPercent: 100, ease: Expo.easeInOut }, 0.2)
                    .from(
                      i,
                      0.8,
                      {
                        x: 0.5 * (app.windowWidth - 4 * i.width()),
                        scaleX: 4,
                        ease: Expo.easeInOut,
                      },
                      0.8
                    )
                    .from(n, 0.8, { yPercent: 100, ease: Expo.easeInOut }, 0.6);
                }),
                e
              );
            })(l.default));
            ...
            (function (t) {
              ...
              return (
                ...
                (e.prototype.populateTimeline = function () {
                  ...
                  this.timeline
                    .set(e, { visibility: "inherit" })
                    .to(e, 0.9, { xPercent: -100, ease: Expo.easeInOut }, 0.7);
                }),
                e
              );
            })(l.default));
            ...
            (function (t) {
              ...
              return (
                ...
                (e.prototype.populateTimeline = function () {
                  ...
                  this.timeline
                    .to([i, n], 0.5, { opacity: 0 }, 0)
                    .to(
                      e,
                      0.7,
                      { xPercent: -60, opacity: 0, ease: Quart.easeIn },
                      "-=.3"
                    );
                }),
                e
                ...
                (e.prototype.populateTimeline = function () {
                  ...
                  this.timeline
                    .to(
                      n,
                      0.8,
                      { yPercent: 50, opacity: 0, ease: Quart.easeIn },
                      0
                    )
                    .to(s, 0.6, { y: 100, opacity: 0, ease: Quart.easeIn }, 0.2)
                    .to(
                      e,
                      0.6,
                      { x: 100 - e[0].offsetLeft, ease: Expo.easeInOut },
                      0.2
                    )
                    .set(i, { visibility: "inherit" }, 0)
                    .fromTo(
                ...
                (e.prototype.populateTimeline = function () {
                  ...
                  this.timeline
                    .to(
                      e,
                      0.8,
                      { xPercent: -100, opacity: 0, ease: Quart.easeIn },
                      0
                    )
                    .to(
                      n,
                    ...
                    .to(
                      i,
                      0.8,
                      { x: -i[0].offsetLeft - i.width(), ease: Quart.easeIn },
                      0
                    );
                }),
                e
          ...
          u = (function (t) {
            function e(i) {
              ...
              return (
                ...
                (n.links = n.element
                  .find(".projects__nav__link")
                  .on("click", n.onLinkClick.bind(n))),
                (n.expandBtn = $("#projects__nav__expand").on(
                  "click",
                  n.onExpandBtnClick.bind(n)
                )),
                (n.shrinkBtn = $("#projects__nav__shrink").on(
                  "click",
                  n.onShrinkBtnClick.bind(n)
                )),
            ...
            return (
              ...
              (e.prototype.selectItem = function (t) {
                var e = 1,
                  i = this.selectedItem;
                if (
                  ((this.selectedItem = this.list.find(
                    ".projects__nav__item[data-id=" + t + "]"
                  )),
                  i[0] !== this.selectedItem[0])
                ) {
                  this.selectedItem.addClass(c);
                  var n = this.selectedItem.find(".projects__nav__index__line");
                  if (
                    (i &&
                      this.getItemIndex(i[0]) >
                        this.getItemIndex(this.selectedItem[0]) &&
                      (e = -1),
                    i)
                  ) {
                ...
                if (!this.isExpanded) {
                  ...
                  s.each(function (t, e) {
                    ...
                    (this.expandTimeline = new TimelineMax({
                      ...
                      .fromTo(t, 0.3, { autoAlpha: 0 }, { autoAlpha: 1 }, 0)
                      .from(
                        "#projects__nav__overlay",
                        0.8,
                        { scaleX: 0, ease: Expo.easeInOut },
                        0
                      )
                      .set(
                        this.expandBtn,
                      ...
                      .fromTo(
                        ...
                        0.6,
                        { autoAlpha: 1 },
                        { autoAlpha: 0, xPercent: -50, ease: Quad.easeIn },
                        0
                      )
                      .from(
                        l,
                      ...
                      .staggerFrom(
                        s,
                        0.6,
                        { cycle: { x: r, y: a }, ease: Quad.easeInOut },
                        0,
                        0
                      )
                      .staggerFrom(
                      ...
                      .from(
                        this.shrinkBtn,
                        0.8,
                        { autoAlpha: 0, x: -50, ease: Expo.easeOut },
                        0.5
                      )),
                    this.onExpanded();
                }
              ...
              (e.prototype.shrink = function () {
                if (this.isExpanded) {
                  ...
                  a.each(function (t, e) {
                    ...
                    (this.shrinkTimeline = this.expandTimeline =
                      new TimelineMax({
                        ...
                        .to(e, 0.7, { autoAlpha: 0 }, 0)
                        .fromTo(
                          this.shrinkBtn,
                          0.3,
                          { autoAlpha: 1, x: v, y: b },
                          { autoAlpha: 0, x: v - 50, ease: Quad.easeIn },
                          0
                        )
                        .staggerFrom(
                          n,
                          0.6,
                          { cycle: { x: o, y: r, ease: Expo.easeInOut } },
                          0,
                          0.1
                        )
                        .from(
                          f,
                          0.6,
                          { y: w, scaleY: x, ease: Quad.easeInOut },
                          0
                        )
                        .set(a, { width: c, height: u }, 0)
                        .staggerFromTo(
                          a,
                          0.4,
                          { cycle: { x: h, y: p }, autoAlpha: 1 },
                          {
                            cycle: {
                              x: function (t) {
                                return h[t] - 30;
                        ...
                        .add(this.goToClickedProject.bind(this), "-=.7")),
                    this.onExpanded();
                }
              }),
              (e.prototype.goToClickedProject = function () {
                this.clickedProjectId &&
                  (this.emit("projectClick", this.clickedProjectId),
                  (this.clickedProjectId = null));
              }),
              ...
              (e.prototype.onKeyUp = function (t) {
                if (!this.expandTimeline && !this.shrinkTimeline)
                  switch (t.keyCode) {
                    case 27:
                      this.shrink();
                  }
            ...
            return (
              ...
              (e.prototype.init = function () {
                (this.initialized = !0),
                  ...
                  this.media.on(
                    "fullscreen",
                    this.onMediaFullscreen.bind(this)
                  ),
                  (this.tags = this.element.find(".project__tags")),
                  (this.moreBtn = this.element
                    .find(".project__desc__more")
                    .on("click", this.onMoreBtnClick.bind(this))),
              ...
              (e.prototype.dispose = function () {
                t.prototype.dispose.call(this),
                  this.initialized &&
                    (this.disposeTimelineIn(),
                    this.disposeTimelineOut(),
                    this.media.off("fullscreen"),
                    this.media.dispose(),
                    (this.media = null),
                    this.moreBtn.off("click"),
                    (this.moreBtn = null));
              }),
              (e.prototype.disposeTimelineIn = function () {
                if (this.timelineIn) {
              ...
              (e.prototype.animateIn = function (e) {
                if (
                  ...
                  if ((this.media.show(), i))
                    return (
                      this.onAnimateInStart(), void this.onAnimateInComplete()
                    );
                  var n = this.element.find(".project__title"),
                    s = new f.default(n, { type: "lines" }),
                  ...
                  o && o.length && (document.title = o),
                    (this.timelineIn = new TimelineMax({
                      ...
                      this.element.find(".project__tag"),
                      0.7,
                      {
                        y: -50 * this.direction,
                        opacity: 0,
                    ...
                    app.windowWidth >= app.screenM
                      ? this.timelineIn
                          ...
                          .staggerFrom(
                            ...
                            -0.1 * this.direction,
                            "body" + (1 === this.direction ? "+=.1" : "")
                          )
                          .from(
                            this.element.find(".project__desc"),
                            0.7,
                            {
                              y: -60 * this.direction,
                              autoAlpha: 0,
                            ...
                            "body" + (1 === this.direction ? "" : "+=.2")
                          )
                          .addLabel("media", 0)
                          .set(this.media.element, { zIndex: "" }, "media")
                          .from(
                            this.media.element,
                            0.7,
                            {
                              y:
                                (this.media.element.offset().top +
                                  this.media.element.height()) *
                                this.direction *
                                -1,
                              ease: Expo.easeInOut,
                            },
                          ...
                          .from(
                            this.media.navigator.currentScreen.element,
                            0.7,
                            {
                          ...
                          .from(
                            this.media.nav.element,
                            0.7,
                            { autoAlpha: 0 },
                            "media+=.7"
                          )
                      : this.timelineIn
                          .set(this.media.element, { zIndex: 3 }, 0)
                          .set(n, { zIndex: 4 }, 0)
                          .from(
                            this.media.element,
                            0.7,
                          ...
                          .staggerFrom(
                            [
                              n,
                              this.element.find(".project__desc__content"),
                              this.element.find(".project__desc__more"),
                            ],
                            0.7,
                            {
              ...
              (e.prototype.animateOut = function (e) {
                ...
                (this.timelineOut = new TimelineMax({
                  ...
                  this.element.find(".project__tag"),
                  0.4,
                  { y: 50 * this.direction, opacity: 0, ease: Quart.easeIn },
                  0.07,
                  0.1
                )),
                  app.windowWidth >= app.screenM
                    ? this.timelineOut
                        ...
                        .to(this.media.nav.element, 0.3, { opacity: 0 }, 0)
                    : this.timelineOut
                        .set(this.media.element, { zIndex: 2 }, 0)
                        .set(i, { zIndex: 3 }, 0)
                        .to(
                          this.media.element,
                          0.7,
              ...
              (e.prototype.onAnimateOutComplete = function () {
                t.prototype.onAnimateOutComplete.call(this),
                  this.disposeTimelineOut(),
                  (this.element[0].style.visibility =
                    this.tags[0].style.visibility =
                    this.title[0].style.visibility =
                      "");
              }),
              (e.prototype.onMediaFullscreen = function (t) {
                var e = this;
                  ...
                  t
                    ? (app.windowWidth >= app.screenM
                        ? TweenMax.staggerTo(
                            ...
                            0.4,
                            { x: -100, autoAlpha: 0, ease: Quart.easeIn },
                            0.05
                          )
                        : TweenMax.staggerTo(this.title, 0.6, {
                            y: 100,
                            autoAlpha: 0,
                            ease: Expo.easeInOut,
                          }),
                      TweenMax.to(this.tags, 0.5, {
                        yPercent: 100,
                        ease: Quart.easeIn,
                      }))
                    : (app.windowWidth >= app.screenM
                        ...
                        : TweenMax.staggerTo(this.title, 0.7, {
                            y: 0,
                            autoAlpha: 1,
                            ease: Expo.easeInOut,
                            onComplete: function () {
                      ...
                      TweenMax.to(this.tags, 0.7, {
                        delay: 0.3,
                        yPercent: 0,
                        ease: Expo.easeOut,
                        onComplete: function () {
                          TweenMax.set(e.tags, { clearProps: "all" });
                        },
                      })),
          ...
          b = (function (t) {
            function e(i) {
              ...
              return (
                ...
                (n.items = []),
                (n.firstItemIndex = n.element[0].getAttribute(
                  "data-first-media-index"
                )),
                (n.nav = new d.default({
                  element: n.element.find(".project__media__nav"),
                })),
                n.nav.on("click", n.onNavClick.bind(n)),
                (n.moreBlock = n.element
                  .find(".project__media__more")
                  .on("click", n.onMoreBlockClick.bind(n))),
                (n.closeBtn = n.element
                  .find(".project__media__close")
                  .on("click", n.onCloseBtnClick.bind(n))),
                n.initNavigator(),
                (n.window = $(window).on("keyup." + n.uid, n.onKeyUp.bind(n))),
                (n.hammer = null),
                Modernizr.touchevents &&
                  ((n.hammer = new y.default.Manager(n.element[0], {
                    recognizers: [
                      [
                        y.default.Swipe,
            ...
            return (
              ...
              (e.prototype.initNavigator = function () {
                var t = this;
                (this.navigator = new p.default()),
                  (this.navigator.transition = h.Transitions.outAndIn),
                  this.element
                    .find(".project__media__item")
                    .each(function (e, i) {
                      var n = "media-" + e,
                        s = new u.default({
                          index: e,
              ...
              (e.prototype.disposeTimelineOpenFullscreen = function () {
                this.timelineOpenFullscreen &&
                  (this.timelineOpenFullscreen.kill(),
                  (0, _.default)(this.timelineOpenFullscreen),
                  (this.timelineOpenFullscreen = null));
              }),
              (e.prototype.disposeTimelineCloseFullscreen = function () {
                this.timelineCloseFullscreen &&
                  (this.timelineCloseFullscreen.kill(),
                  (0, _.default)(this.timelineCloseFullscreen),
                  (this.timelineCloseFullscreen = null));
              }),
              ...
              (e.prototype.gotoItem = function (t) {
                if (
                  !this.project.owner.transitionRunning &&
                  ...
                  if (this.navigator.getItem(e)) {
                    ...
                    this.navigator.currentScreen &&
                      (this.navigator.currentScreen.direction = i),
              ...
              (e.prototype.openFullscreen = function () {
                if (!this.isFullscreen) {
                  ...
                  (this.timelineOpenFullscreen = new TimelineMax({
                    ...
                    .from(
                      this.element.find(".project__media__close__label"),
                      0.5,
                      { opacity: 0 },
                      0.2
                    )
                    .from(
                      this.element.find(".project__media__close__btn"),
                      0.8,
                    ...
                    app.windowWidth >= app.screenM
                      ? this.timelineOpenFullscreen
                          .from(
                            this.element.find(".project__media__overlay"),
                            0.5,
                            { opacity: 0 },
                            0
                          )
                          ...
                          .from(
                            this.nav.element.find(".project__media__nav__bg"),
                            0.8,
                            { scaleX: f, ease: Quart.easeInOut },
                            0
                          )
                          .from(
                            this.nav.nextBtn[0],
                          ...
                          .staggerFrom(
                            this.nav.element.find(".project__media__nav__item"),
                            0.7,
                      ...
                      : this.timelineOpenFullscreen
                          .fromTo(
                            this.element.find(".project__media__overlay"),
                            0.8,
                            { autoAlpha: 0.6, scaleY: l / o.height() },
                            { autoAlpha: 0, scaleY: 1, ease: Expo.easeInOut },
                            0
                          )
                          .from(
                            this.nav.element,
                            0.8,
                            { yPercent: 100, ease: Quart.easeOut },
                            0.4
                          )
                          .fromTo(
                            o,
              ...
              (e.prototype.closeFullscreen = function () {
                if (this.isFullscreen) {
                  ...
                  (this.timelineCloseFullscreen = new TimelineMax({
                    ...
                    .set(
                      this.closeBtn,
                      { x: e.left - y.left, y: e.top - y.top },
                      0
                    )
                    .set(
                      this.element.find(".project__media__close"),
                      { autoAlpha: 1 },
                      0
                    )
                    .to(
                    ...
                    app.windowWidth >= app.screenM
                      ? this.timelineCloseFullscreen
                          .set(
                            t,
                            { y: -g.top, x: -g.left, width: app.windowWidth },
                            0
                          )
                          .from(t, 0.9, { autoAlpha: 1 }, 0)
                          .set(
                            p.find(".project__media__more"),
                            { autoAlpha: 0 },
                            0
                          )
                          .from(
                          ...
                          .from(
                            this.nav.element.find(".project__media__nav__bg"),
                            0.6,
                            { scaleX: b, ease: Quart.easeInOut },
                            0
                          )
                          .from(
                            this.nav.element.find(
                              ".project__media__nav__btn--next"
                            ),
                            0.6,
                            { x: r - x, ease: Quart.easeInOut },
                            0
                          )
                          .set(a, { autoAlpha: 1, x: l - a[0].offsetLeft }, 0)
                          .to(
                            this.nav.element.find(".project__media__nav__item"),
                            0.7,
                            { opacity: 0 },
                          ...
                          .fromTo(
                            ...
                            0.8,
                            {
                              clip:
                                ...
                                I +
                                "," +
                                (app.windowWidth - T.left) +
                                "," +
                                (app.windowHeight - T.top) +
                                "," +
                                S +
                                ")",
                            },
                      ...
                      : this.timelineCloseFullscreen
                          ...
                          .to(
                            this.nav.element,
                            0.8,
                            { yPercent: 100, ease: Quart.easeInOut },
                            0
                          )
                          .from(
                            this.element.find(".project__media__overlay"),
              ...
              (e.prototype.onKeyUp = function (t) {
                if (
                  !(
                    this.navigator.transitionRunning ||
                    this.timelineOpenFullscreen ||
                    this.timelineCloseFullscreen
                  )
                )
              ...
              (e.prototype.onSwipe = function (t) {
                t.direction === y.default.DIRECTION_LEFT
                  ? this.gotoNextItem()
                  : t.direction === y.default.DIRECTION_RIGHT &&
                    this.gotoPrevItem();
              }),
              e
            );
        ...
        var h = (function (t) {
          function e(i) {
            ...
            return (
              ...
              (o.type = o.element.hasClass("project__media__item--video")
                ? "video"
                : "image"),
              ...
              (o.isVisible = !1),
              (o.direction = 1),
              (o.loader = new l.default(o.img[0])),
              o
            );
          }
          return (
            ...
            (e.prototype.init = function () {
              (this.initialized = !0),
                this.container.on(
                  "openFullscreenComplete",
                  this.onOpenFullscreenComplete.bind(this)
                ),
                this.container.on(
                  "closeFullscreenStart",
                  this.onCloseFullscreenStart.bind(this)
                );
            }),
            (e.prototype.dispose = function () {
              t.prototype.dispose.call(this),
                this.initialized &&
                  ((this.element[0].style.visibility = ""),
                  this.container.off("openFullscreenComplete"),
                  this.container.off("closeFullscreenStart"),
                  this.loader.dispose());
            }),
            (e.prototype.load = function () {
            ...
            (e.prototype.resize = function (t) {
              var e = this.img[0].naturalWidth,
                ...
                p = parseInt(0.5 * (n - l)),
                c = parseInt(0.5 * (s - h));
              this.img.css({ width: l, height: h, top: c, left: p });
            }),
            (e.prototype.addPlayer = function () {
            ...
            (e.prototype.animateIn = function (e) {
              if (
                (t.prototype.animateIn.call(this, e), (this.isVisible = !0), !e)
              ) {
                if (
                  (TweenMax.killTweensOf(this.element),
                  this.init(),
                  this.resize(),
                  (this.element[0].style.visibility = "inherit"),
                  this.container.project.owner.transitionRunning)
                )
                  return (
                    this.onAnimateInStart(), void this.onAnimateInComplete()
                  );
            ...
            (e.prototype.onAnimateInComplete = function () {
              t.prototype.onAnimateInComplete.call(this),
                TweenMax.set(this.element, { clearProps: "x" }),
                "video" === this.type &&
          ...
          h = (function (t) {
            function e(i) {
              ...
              return (
                ...
                (o.itemsBtns = o.element
                  .find(".project__media__nav__item__btn")
                  .on("click", o.onItemBtnClick.bind(o))),
                (o.nextBtn = o.element
                  .find(".project__media__nav__btn--next")
                  .on("click", o.onNextBtnClick.bind(o))),
                (o.prevBtn = o.element
                  .find(".project__media__nav__btn--prev")
                  .on("click", o.onPrevBtnClick.bind(o))),
                (o.isVisible = !0),
            ...
            return (
              ...
              (e.prototype.clearAutoHideTimeout = function () {
                0 !== this.autoHideTimeoutId &&
                  (clearTimeout(this.autoHideTimeoutId),
                  (this.autoHideTimeoutId = 0));
              }),
              (e.prototype.addUserActivityListeners = function () {
                this.element
                  .parent()
                  .on("mousemove.internal", this.onMouseMove.bind(this)),
                  this.element
                    .on("mouseenter.internal", this.onMouseEnter.bind(this))
                    .on("mouseleave.internal", this.onMouseLeave.bind(this));
              }),
              ...
              (e.prototype.onMouseMove = function () {
                this.autoHideLocked ||
                  (this.isVisible ? this.autoHide() : this.show());
              }),
              (e.prototype.onShowComplete = function () {
        ...
        var r = t("tiny-emitter"),
          ...
          l = (function (t) {
            function e(i) {
              ...
              var o = s(this, t.call(this));
              return (
                (o.element = $("#projects__scroll-cta")),
                (o.label = $("#projects__scroll-cta__label")),
                (o.btn = $("#projects__scroll-cta__btn").on(
                  "click",
                  o.onBtnClick.bind(o)
                )),
                (o.isVisible = !1),
                  ...
                  t
                    ...
                    ? TweenMax.fromTo(
                        ...
                        { xPercent: 100, yPercent: 0, autoAlpha: 0 },
                        {
                          ...
                          ease: Expo.easeOut,
                          onComplete: function () {
                            TweenMax.set(e.element, { clearProps: "all" });
                          },
                        }
                      )
                    : TweenMax.fromTo(
                        this.element,
                        0.6,
                        { xPercent: 0, yPercent: 100, autoAlpha: 1 },
                        {
                          delay: 0.3,
                          yPercent: 0,
                          ease: Expo.easeOut,
    ...
    68: [
      function (t, e, i) {
        ...
        function s(t, e, i) {
          var n = e[i];
          if (void 0 !== n && null !== n) {
            if (a.call(t, i) && (void 0 === t[i] || null === t[i]))
              throw new TypeError(
            ...
            i._gsDefine(
              ...
              function (t, e, i) {
                  ...
                  (o.killChildTweensOf = function (t, e) {
                    if (null != t) {
                      ...
                      if (
                        ...
                        s = [];
                        for (p in f)
                          for (h = f[p].target.parentNode; h; )
                            h === t && (s = s.concat(f[p].tweens)),
                              (h = h.parentNode);
                        for (u = s.length, c = 0; c < u; c++)
                ...
                var f = function (t, i, n, s) {
                  (i = !1 !== i), (n = !1 !== n), (s = !1 !== s);
                  for (
                    var o, r, a = u(s), l = i && n && s, h = a.length;
                    --h > -1;
                ...
                function (t, e, n) {
                  ...
                  return (
                    ...
                    (_.to = function (t, e, i, s) {
                      ...
                      return e
                        ? this.add(new o(t, e, i), s)
                        : this.set(t, i, s);
                    }),
                    (_.from = function (t, e, i, s) {
                      return this.add(
                        ((i.repeat && c.TweenMax) || n).from(t, e, i),
                        s
                      );
                    }),
                    ...
                    (_.add = function (i, o, r, a) {
                      ...
                      if (
                        ("number" != typeof o &&
                          (o = this._parseTimeOrLabel(o, 0, !0, i)),
                        !(i instanceof t))
                      ) {
                            ...
                            l((u = i[c])) && (u = new s({ tweens: u })),
                              ...
                              "string" != typeof u &&
                                ...
                                ("sequence" === r
                                  ? (h =
                                      u._startTime +
                                      u.totalDuration() / u._timeScale)
                                  : "start" === r &&
                                    (u._startTime -= u.delay())),
                              (h += a);
                      ...
                      if (
                        (e.prototype.add.call(this, i, o),
                        i._time &&
                          i.render(
                            (this.rawTime() - i._startTime) * i._timeScale,
                            !1,
                            !1
                          ),
                        ...
                        for (
                          f = this, d = f.rawTime() > i._startTime;
                          f._timeline;
                    ...
                    (_.render = function (t, e, i) {
                      ...
                      if ((this._time !== u && this._first) || i || a || l) {
                        ...
                        this._onUpdate &&
                          (e || (h.length && p(), this._callback("onUpdate"))),
                          r &&
                            (this._gc ||
                              (d !== this._startTime &&
                                m === this._timeScale) ||
                      ...
                      for (var o = [], r = this._first, a = 0; r; )
                        r._startTime < s ||
                          (r instanceof n
                            ...
                            : (!1 !== i && (o[a++] = r),
                              !1 !== t &&
                                ((o = o.concat(r.getChildren(!0, e, i))),
                                (a = o.length)))),
                          (r = r._next);
                      return o;
                    }),
                    ...
                    (_.totalDuration = function (t) {
                      if (!arguments.length) {
                        if (this._dirty) {
                          for (
                            var e, i, n = 0, s = this._last, o = 999999999999;
                            s;
                  ...
                  return (
                    ...
                    (p.tweenTo = function (t, i) {
                      ...
                      return (
                        ...
                        (n =
                          Math.abs(Number(r.time) - this._time) /
                    ...
                    (p.render = function (t, e, i) {
                      ...
                      if (this._cycle !== w && !this._locked) {
                        ...
                        if (
                          ...
                          (this._time = f),
                          (this._rawPrevTime = 0 === m ? v - 1e-4 : v),
                          (this._cycle = w),
                          (this._locked = !0),
                          (f = x ? 0 : m),
                          this.render(f, e, 0 === m),
              ...
              (function () {
                var t = 180 / Math.PI,
                      ...
                      (f = t[T]),
                        ...
                        a
                          ? ((v = e[h]),
                            (b = n[h]),
                            (w =
                              ((b + v) * i * 0.25) / (r ? 0.5 : s[h] || 0.5)),
                            (d =
                              c -
                              (c - p) * (r ? 0.5 * i : 0 !== v ? w / v : 0)),
                            (m =
                              c +
                              (u - c) * (r ? 0.5 * i : 0 !== b ? w / b : 0)),
                            (_ =
                              c -
                              (d +
                                (((m - d) * ((3 * v) / (v + b) + 0.5)) / 4 ||
                  ...
                  p = function (t, i, s, o) {
                    ...
                    if (o)
                      for (t = [o].concat(t), l = t.length; --l > -1; )
                        "string" == typeof (u = t[l][i]) &&
                          "=" === u.charAt(1) &&
                          (t[l][i] = o[i] + Number(u.charAt(0) + u.substr(2)));
                    if ((r = t.length - 2) < 0)
                      return (f[0] = new a(t[0][i], 0, 0, t[0][i])), f;
                    for (l = 0; l < r; l++)
                      (h = t[l][i]),
                        (p = t[l + 1][i]),
                        (f[l] = new a(h, 0, 0, p)),
                  ...
                  c = function (t, i, r, a, l, c) {
                    ...
                    if (t.length > 1) {
                      for (
                        v = t[t.length - 1], y = !0, u = w.length;
                        --u > -1;

                      )
                        if (((f = w[u]), Math.abs(x[f] - v[f]) > 0.05)) {
                          y = !1;
                          break;
                        }
                      y &&
                    ...
                    for (
                      e.length = n.length = s.length = 0, u = w.length;
                      --u > -1;
                      ...
                      (f = w[u]),
                        ...
                        (b[f] = p(t, f, o[f], c));
                    for (u = e.length; --u > -1; )
                      (e[u] = Math.sqrt(e[u])), (n[u] = Math.sqrt(n[u]));
                    if (!a) {
                      for (u = w.length; --u > -1; )
                        if (o[f])
                          for (d = b[w[u]], g = d.length - 1, m = 0; m < g; m++)
                            (_ = d[m + 1].da / n[m] + d[m].da / e[m] || 0),
                              (s[m] = (s[m] || 0) + _ * _);
                      for (u = s.length; --u > -1; ) s[u] = Math.sqrt(s[u]);
                    }
                    for (u = w.length, m = r ? 4 : 1; --u > -1; )
                      (f = w[u]),
                        (d = b[f]),
                        h(d, i, r, a, o[f]),
                  ...
                  u = function (t, e, i) {
                    ...
                    for (h = y.length; --h > -1; ) {
                      for (
                        u = y[h], m[u] = l = [], f = 0, c = t.length, p = 0;
                        p < c;
                        p++
                      )
                        (n =
                          null == i
                            ? t[p][u]
                            : "string" == typeof (d = t[p][u]) &&
                              "=" === d.charAt(1)
                            ? i[u] + Number(d.charAt(0) + d.substr(2))
                            : Number(d)),
                          g &&
                            p > 1 &&
                            p < c - 1 &&
                ...
                function (t, e) {
                  ...
                  var c,
                    ...
                    $ = (function () {
                      ...
                      return (
                        (f =
                          -1 !== q.indexOf("Safari") &&
                          -1 === q.indexOf("Chrome") &&
                          (-1 === t || parseFloat(q.substr(t + 8, 2)) > 3)),
                        (m =
                          f &&
                    ...
                    et = (X.convertToPixels = function (t, i, n, s, o) {
                      ...
                      if (
                        ...
                        if ("%" === s && -1 !== i.indexOf("border"))
                          r = (n / 100) * (p ? t.clientWidth : t.clientHeight);
                        else {
                          if (
                            ((u.cssText =
                            ...
                            u[p ? "borderLeftWidth" : "borderTopWidth"] = n + s;
                          else {
                            if (
                              ((c = t.parentNode || H.body),
                              -1 !== tt(c, "display").indexOf("flex") &&
                                (u.position = "absolute"),
                              (l = c._gsCache),
                              (h = e.ticker.frame),
                              l && p && l.time === h)
                    ...
                    it = (X.calculateOffset = function (t, e, i) {
                      ...
                      return (
                        t["offset" + n] -
                        (et(t, e, parseFloat(s), s.replace(T, "")) || 0)
                      );
                    }),
                    nt = function (t, e) {
                      var i,
                      ...
                      if ((e = e || K(t, null)))
                        if ((i = e.length))
                          for (; --i > -1; )
                            (s = e[i]),
                              (-1 !== s.indexOf("-transform") && At !== s) ||
                                (o[s.replace(k, E)] = e.getPropertyValue(s));
                        else
                          for (i in e)
                            (-1 !== i.indexOf("Transform") && kt !== i) ||
                              (o[i] = e[i]);
                    ...
                    at = function (t, e, i) {
                      ...
                      for (i = i || K(t, null); --o > -1; )
                        (n -= parseFloat(tt(t, "padding" + s[o], i, !0)) || 0),
                          (n -=
                            parseFloat(
                              tt(t, "border" + s[o] + "Width", i, !0)
                            ) || 0);
                      return n;
                    },
                    lt = function (t, e) {
                  ...
                  var gt = function (t, e, i, n) {
                    ...
                    bt =
                      ((X._parseToProxy = function (t, e, i, n, s, o) {
                        var r,
                          a,
                          l,
                          h,
                        ...
                        return { proxy: u, end: f, firstMPT: h, pt: p };
                      }),
                    ...
                    xt = (a.parseComplex = function (
                      ...
                      for (
                        ...
                        if (
                          ...
                          (C = _.indexOf(")") + 1),
                            ...
                            S && !$ && 0 === _[3]
                              ? ((r["xs" + r.l] += r.l
                                  ? " transparent"
                                  : "transparent"),
                                (r.e = r.e.split(A[u]).join("transparent")))
                              : ($ || (S = !1),
                                P
                                  ? r
                                      .appendXtra(
                                        I.substr(0, I.indexOf("hsl")) +
                                          (S ? "hsla(" : "hsl("),
                                        m[0],
                                        ht(_[0], m[0]),
                                        ",",
                          ...
                          if (!(x = _.match(b)) || x.length !== w.length)
                            return r;
                          for (d = 0, f = 0; f < w.length; f++)
                            (O = w[f]),
                              (I = m.indexOf(O, d)),
                              r.appendXtra(
                                m.substr(d, I - d),
                                ...
                                ht(x[f], O),
                                "",
                                j && "px" === m.substr(I + O.length, 2),
                                0 === f
                              ),
                              (d = I + O.length);
                          r["xs" + r.l] += m.substr(d);
                        } else
                          r["xs" + r.l] += r.l || r["xs" + r.l] ? " " + _ : _;
                      if (-1 !== n.indexOf("=") && r.data) {
                        for (C = r.xs0 + r.data.s, u = 1; u < r.l; u++)
                          C += r["xs" + u] + r.data["xn" + u];
                        r.e = C + r["xs" + u];
                      }
                      return (
                        r.l || ((r.type = -1), (r.xs0 = r.e)), r.xfirst || r
                      );
                    }),
                    Tt = 9;
                  for (p = bt.prototype, p.l = p.pr = 0; --Tt > 0; )
                    (p["xn" + Tt] = 0), (p["xs" + Tt] = "");
                  (p.xs0 = ""),
                    (p._next =
                      p._prev =
                  ...
                  (p = St.prototype),
                    ...
                    (p.parse = function (t, e, i, n, s, r, a) {
                      return this.parseComplex(
                        t.style,
                        this.format(tt(t, this.p, o, !1, this.dflt)),
                        this.format(e),
                        s,
                        r
                      );
                  ...
                  var Ct,
                    ...
                    Rt = (X.Transform = function () {
                      (this.perspective =
                        ...
                        (this.force3D =
                          !(!1 === a.defaultForce3D || !jt) &&
                          (a.defaultForce3D || "auto"));
                    }),
                    Mt = i.SVGElement,
                    Lt = function (t, e, i) {
                      var n,
                        s = H.createElementNS("http://www.w3.org/2000/svg", t),
                        o = /([a-z])([A-Z])/g;
                      for (n in i)
                        s.setAttributeNS(
                          null,
                    ...
                    Nt = function (t, e, i, n, s, o) {
                      ...
                      w && ((v = w.xOrigin), (b = w.yOrigin)),
                        ...
                        n &&
                          ...
                          (y = u * m - f * d) &&
                            ((l =
                              p * (m / y) + c * (-d / y) + (d * g - m * _) / y),
                            (h =
                              p * (-f / y) + c * (u / y) - (u * g - f * _) / y),
                            (p = i.xOrigin = r[0] = l),
                            (c = i.yOrigin = r[1] = h))),
                        w &&
                          (o &&
                    ...
                    Vt = function (t, e) {
                      ...
                      if (
                        ...
                        !kt ||
                          ...
                          t.parentNode || ((r = 1), zt.appendChild(t)),
                          (n = tt(t, At, null, !0)),
                          (i =
                            !n ||
                            "none" === n ||
                            "matrix(1, 0, 0, 1, 0, 0)" === n),
                          o ? (h.display = o) : a && Qt(h, "display"),
                          r && zt.removeChild(t)),
                        (l.svg || (t.getCTM && Ht(t))) &&
                          (i &&
                    ...
                    Yt = (X.getTransform = function (t, i, n, s) {
                      ...
                      var o,
                        ...
                        p,
                        c,
                        u = n ? t._gsTransform || new Rt() : new Rt(),
                        f = u.scaleX < 0,
                        d = jt
                          ? parseFloat(
                              tt(t, Et, i, !1, "0 0 0").split(" ")[2]
                            ) ||
                            u.zOrigin ||
                            0
                          : 0,
                        ...
                        if (16 === o.length) {
                          ...
                          u.zOrigin &&
                            ...
                            z &&
                              ...
                              (k = y)),
                            u.rotationX &&
                              Math.abs(u.rotationX) + Math.abs(u.rotation) >
                                359.9 &&
                            ...
                            (u.scaleX =
                              ...
                              1e5),
                            (u.scaleY =
                              ((1e5 * Math.sqrt(O * O + C * C) + 0.5) | 0) /
                              1e5),
                            (u.scaleZ =
                              ((1e5 * Math.sqrt(k * k + A * A + E * E) + 0.5) |
                                0) /
                              1e5),
                            (w /= u.scaleX),
                            (I /= u.scaleY),
                            ...
                            u.svg &&
                              ((u.x -=
                                u.xOrigin - (u.xOrigin * w - u.yOrigin * I)),
                              (u.y -=
                                u.yOrigin - (u.yOrigin * x - u.xOrigin * O)));
                        } else if (
                          !jt ||
                          s ||
                          !o.length ||
                          ...
                          (u.x = o[4] || 0),
                            ...
                            (h = Math.sqrt(W * W + H * H)),
                            (p =
                              B || D ? Math.atan2(D, B) * N : u.rotation || 0),
                            (c =
                              H || W ? Math.atan2(H, W) * N + p : u.skewX || 0),
                            (u.scaleX = l),
                            (u.scaleY = h),
                            (u.rotation = p),
                            (u.skewX = c),
                            ...
                            u.svg &&
                              ((u.x -=
                                u.xOrigin - (u.xOrigin * B + u.yOrigin * H)),
                              (u.y -=
                                u.yOrigin - (u.xOrigin * D + u.yOrigin * W)));
                        }
                        Math.abs(u.skewX) > 90 &&
                    ...
                    Xt = function (t) {
                      ...
                      if (c) {
                        ...
                        if (
                          (null != n.ox &&
                            ((u = (n.oxp ? d * n.ox * 0.01 : n.ox) - d / 2),
                            (f = (n.oyp ? m * n.oy * 0.01 : n.oy) - m / 2),
                            (v += u - (u * r + f * a)),
                            (b += f - (u * l + f * h))),
                          g
                            ? ((u = d / 2),
                            ...
                            return void (C || H || z
                              ? ((C *= F),
                                ...
                                z &&
                                  ((R +=
                                    I.xOrigin -
                                    (I.xOrigin * i + I.yOrigin * n) +
                                    I.xOffset),
                                  (M +=
                                    I.yOrigin -
                                    (I.xOrigin * o + I.yOrigin * r) +
                                    I.yOffset),
                                  Ct &&
                                    (I.xPercent || I.yPercent) &&
                                    ((_ = this.t.getBBox()),
                                    (R += 0.01 * I.xPercent * _.width),
                                    (M += 0.01 * I.yPercent * _.height)),
                                  (_ = 1e-6),
                                  R < _ && R > -_ && (R = 0),
                                  M < _ && M > -_ && (M = 0)),
                                (b =
                  ...
                  (p = Rt.prototype),
                    ...
                    It(
                      "transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin",
                      {
                        parser: function (t, e, i, n, s, r, l) {
                          ...
                          if (
                            ((C.skewType =
                              I.skewType || C.skewType || a.defaultSkewType),
                            (n._transform = C),
                            ...
                            (u = V.style),
                              ...
                              null != I.xPercent &&
                                (c.xPercent = pt(I.xPercent, C.xPercent)),
                              null != I.yPercent &&
                                (c.yPercent = pt(I.yPercent, C.yPercent));
                          else if ("object" == typeof I) {
                            if (
                              ((c = {
                                scaleX: pt(
                                  null != I.scaleX ? I.scaleX : I.scale,
                                  C.scaleX
                                ),
                                scaleY: pt(
                                  null != I.scaleY ? I.scaleY : I.scale,
                                  C.scaleY
                                ),
                            ...
                            "string" == typeof I.x &&
                              -1 !== I.x.indexOf("%") &&
                              ((c.x = 0), (c.xPercent = pt(I.x, C.xPercent))),
                              "string" == typeof I.y &&
                                -1 !== I.y.indexOf("%") &&
                                ((c.y = 0), (c.yPercent = pt(I.y, C.yPercent))),
                              (c.rotation = ct(
                                "rotation" in I
                                  ? I.rotation
                                  : "shortRotation" in I
                                  ? I.shortRotation + "_short"
                                  : "rotationZ" in I
                                  ? I.rotationZ
                                  : C.rotation,
                                C.rotation,
                          ...
                          return (
                            ...
                            C.svg &&
                              ...
                              ((_ = C.xOffset),
                              (v = C.yOffset),
                              Nt(t, lt(P), c, I.svgOrigin, I.smoothOrigin),
                              (s = wt(
                                C,
                                "xOrigin",
                                (x ? C : c).xOrigin,
                          ...
                          this.p.indexOf("border") && (S[h] = J(S[h])),
                            ...
                            b
                              ? ((m = parseInt(f.charAt(0) + "1", 10)),
                                ...
                                (m *= parseFloat(f)),
                                (y =
                                  f.substr((m + "").length - (m < 0 ? 1 : 0)) ||
                                  ""))
                              : ((m = parseFloat(f)),
                                (y = f.substr((m + "").length))),
                            "" === y && (y = s[i] || v),
                            y !== v &&
                              ((w = et(t, "borderLeft", d, v)),
                              (x = et(t, "borderTop", d, v)),
                              "%" === y
                                ? ((u = (w / _) * 100 + "%"),
                                  (c = (x / g) * 100 + "%"))
                                : "em" === y
                      ...
                      "borderBottomLeftRadius,borderBottomRightRadius,borderTopLeftRadius,borderTopRightRadius",
                      {
                        ...
                        parser: function (t, e, i, n, s, r) {
                          return xt(
                            t.style,
                            i,
                            this.format(tt(t, i, o, !1, "0px 0px")),
                            this.format(e),
                            !1,
                            "0px",
                            s
                    ...
                    It("backgroundPosition", {
                      ...
                      parser: function (t, e, i, n, s, r) {
                        ...
                        if (
                          ...
                          g.split(",").length < 2 &&
                          (u = tt(t, "backgroundImage").replace(A, "")) &&
                          "none" !== u
                        ) {
                          for (
                            a = m.split(" "),
                    ...
                    It("backgroundSize", {
                      ...
                      formatter: function (t) {
                        return (
                          (t += ""), lt(-1 === t.indexOf(" ") ? t + " " + t : t)
                        );
                      },
                    }),
                    It("perspective", { defaultValue: "0px", prefix: !0 }),
                    It("perspectiveOrigin", {
                      defaultValue: "50% 50%",
                      prefix: !0,
                    }),
                    It("transformStyle", { prefix: !0 }),
                    It("backfaceVisibility", { prefix: !0 }),
                    It("userSelect", { prefix: !0 }),
                    It("margin", {
                      parser: yt(
                    ...
                    It("border", {
                      ...
                      parser: function (t, e, i, n, s, r) {
                        ...
                        return (
                          "px" !== h &&
                            (a =
                              parseFloat(a) / et(t, "borderTopWidth", 1, h) +
                              h),
                          this.parseComplex(
                            t.style,
                            this.format(
                              a +
                                " " +
                                tt(t, "borderTopStyle", o, !1, "solid") +
                                " " +
                                tt(t, "borderTopColor", o, !1, "#000")
                            ),
                            l.join(" "),
                            s,
                            r
                    ...
                    100 === s &&
                      ...
                      e ||
                        ...
                        -1 === n.indexOf("pacity")
                          ...
                          : (i.filter = n.replace(S, "opacity=" + s)));
                  };
                  ...
                  It("className", {
                    parser: function (t, e, i, s, r, a, l) {
                      var h,
                        ...
                        m = t.style.cssText;
                      if (
                        ((r = s._classNamePT = new bt(t, i, 0, 0, r, 2)),
                        (r.setRatio = Ut),
                        (r.pr = -11),
                        (n = !0),
                        (r.b = d),
                  ...
                  (p = a.prototype),
                    ...
                    (p._enableTransforms = function (t) {
                      (this._transform =
                        this._transform || Yt(this._target, o, !0)),
                        (this._transformType =
                      ...
                      h.length &&
                        ...
                        -1 !== o.indexOf("_cw") && l < 0
                          ...
                          : -1 !== o.indexOf("ccw") &&
                            l > 0 &&
                            (l =
                              ((l - 9999999999 * p) % p) - ((l / p) | 0) * p)),
                      (l > 1e-6 || l < -1e-6) &&
                        (this._addTween(t, s, r, r + l, s),
                        this._overwriteProps.push(s)));
                  return !0;
                },
                set: function (t) {
            ...
            (function (t, i) {
              ...
              if (!o.TweenLite) {
                var r,
                  ...
                  g = function (i, s, r, a) {
                    ...
                    (this.check = function (h) {
                      for (var p, u, f, d, m = s.length, y = m; --m > -1; )
                        (p = _[s[m]] || new g(s[m], [])).gsClass
                          ? ((l[m] = p.gsClass), y--)
                          : h && p.sc.push(this);
                      if (0 === y && r) {
                        if (
                ...
                var I = t.requestAnimationFrame,
                  ...
                  P = C();
                for (
                  r = ["ms", "moz", "webkit", "o"], a = r.length;
                  --a > -1 && !I;

                )
                  (I = t[r[a] + "RequestAnimationFrame"]),
                    (O =
                ...
                (l = E.prototype = new k()),
                  ...
                  (l.render = function (t, e, i) {
                    ...
                    for (
                      ...
                      (n = s._next),
                        (s._active ||
                          (t >= s._startTime && !s._paused && !s._gc)) &&
                          (s._reversed
                            ? s.render(
                                (s._dirty
                                  ? s.totalDuration()
                ...
                var j = v(
                    ...
                    function (e, i, n) {
                      ...
                      this.target = e =
                        "string" != typeof e ? e : j.selector(e) || e;
                      var s,
                        o,
                        r,
                        a =
                                ...
                                ? o.length &&
                                  ...
                                  (o[0] === t ||
                                    (o[0].nodeType &&
                                      ...
                                      !o.nodeType))
                                  ? (r.splice(s--, 1),
                                    (this._targets = r = r.concat(f(o))))
                                  : ((this._siblings[s] = J(o, this, !1)),
                                    1 === l &&
                                      this._siblings[s].length > 1 &&
                                      tt(o, this, null, 1, this._siblings[s]))
                                : "string" ==
                                    typeof (o = r[s--] = j.selector(o)) &&
                                  r.splice(s + 1, 1)
                              : r.splice(s--, 1);
                      else
                        (this._propLookup = {}),
                        ...
                        p === s[a] || s.length <= a
                          ...
                          : (f && (c.push(f), (f = "")),
                            ...
                            (c._firstPT = {
                              ...
                              c:
                                ("=" === p.charAt(1)
                                  ? parseInt(p.charAt(0) + "1", 10) *
                                    parseFloat(p.substr(2))
                                  : parseFloat(p) - r) || 0,
                              f: 0,
                ...
                (U._startTime = h.time),
                  ...
                  setTimeout(Z, 1),
                  (k._updateRoot = j.render =
                    function () {
                      var t, e, i;
                      if (
                        (L.length && Z(),
                        U.render(
                          (h.time - U._startTime) * U._timeScale,
                          !1,
                          !1
                        ),
                        Q.render(
                          (h.frame - Q._startTime) * Q._timeScale,
                          !1,
                          !1
                        ),
                        L.length && Z(),
                ...
                var J = function (t, e, i) {
                  ...
                  et = function (t, e, i) {
                    for (
                      var n = t._timeline, s = n._timeScale, o = t._startTime;
                      n._timeline;

                    ) {
                      if (((o += n._startTime), (s *= n._timeScale), n._paused))
                        return -100;
                      n = n._timeline;
                    }
                    return (
                      ...
                      o > e
                        ...
                        ? 1e-10
                        : (o += t.totalDuration() / t._timeScale / s) >
                          e + 1e-10
                        ? 0
                        : o - e - 1e-10
                    );
                ...
                (l._init = function () {
                  ...
                  if (r.startAt) {
                    ...
                    if (
                      ...
                      (this._startAt = j.to(this.target, 0, s)),
                      h)
                    )
                    ...
                    ((this._ease = p =
                      p
                        ? p instanceof w
                          ? p
                          : "function" == typeof p
                          ? new w(p, r.easeParams)
                          : x[p] || j.defaultEase
                        : j.defaultEase),
                    r.easeParams instanceof Array &&
                      p.config &&
                      (this._ease = p.config.apply(p, r.easeParams)),
                  ...
                  (l._initProps = function (e, i, n, s, o) {
                    ...
                    for (r in this.vars)
                      if (((c = this.vars[r]), q[r]))
                        ...
                        V[r] &&
                        (h = new V[r]())._onInitTween(e, this.vars[r], this, o)
                      ) {
                        for (
                          this._firstPT = p =
                            {
                    ...
                    return s && this._kill(s, e)
                      ? this._initProps(e, i, n, s, o)
                      : this._overwrite > 1 &&
                        this._firstPT &&
                        n.length > 1 &&
                        tt(e, this, i, this._overwrite, n)
                      ? (this._kill(i, e), this._initProps(e, i, n, s, o))
                      : (this._firstPT &&
                          ((!1 !== this.vars.lazy && this._duration) ||
                            (this.vars.lazy && !this._duration)) &&
                          (z[e._gsTweenID] = !0),
                      ...
                      (this._totalTime = this._time = l),
                        ...
                        0 === l &&
                          ...
                          (h < 0 ||
                            ...
                            h !== t &&
                            ((i = !0), h > 1e-10 && (s = "onReverseComplete")),
                          (this._rawPrevTime = r =
                            !e || t || h === t ? t : 1e-10));
                    else if (t < 1e-7)
                      (this._totalTime = this._time = 0),
                  ...
                  (j.killTweensOf = j.killDelayedCallsTo =
                    function (t, e, i) {
                      ...
                      for (
                        var n = j.getTweensOf(t, e), s = n.length;
                        --s > -1;
                ...
                if (
                  ...
                  (it.activate = function (t) {
                    for (var e = t.length; --e > -1; )
                      t[e].API === it.API && (V[new t[e]()._propName] = t[e]);
                    return !0;
                  }),
                  (y.plugin = function (t) {
      ...
      function (t, e, i) {
        !(function (t, i, n, s) {
          ...
          function H(t, e) {
            ...
            return (
              e & (Pt | kt) && (i = b(i.concat(n), "identifier", !0)), [i, n]
            );
          }
          function W() {
            (this.evTarget = Zt),
          ...
          function V(t, e) {
            var i = v(t.touches),
              n = this.targetIds;
            if (e & (Ot | Ct) && 1 === i.length)
              return (n[i[0].identifier] = !0), [i, i];
            var s,
              o,
              r = v(t.changedTouches),
              a = [],
              l = this.target;
            if (
          ...
          var Dt = { mousedown: Ot, mousemove: Ct, mouseup: Pt },
            Ht = "mousedown",
            ...
            h(et, tt, {
              ...
              attrTest: function (t) {
                return (
                  ...
                  (this.state & he ||
                    (!(this.state & he) && this.directionTest(t)))
                );
              },
              emit: function (t) {
              ...
              process: function (t) {
                ...
                if (n && s && i) {
                  ...
                  var r = !this.pTime || t.timeStamp - this.pTime < e.interval,
                    a =
                      !this.pCenter ||
                      M(this.pCenter, t.center) < e.posThreshold;
              ...
              var i,
                ...
                T = (function () {
                  var t,
                    ...
                    r = function () {
                      var e = o;
                      for (o = n.length ? s : n, t = !0, i = !1; e.length; )
                        e.shift()();
                      t = !1;
                    },
                    a = function (n, s) {
              ...
              var C = (function () {
                  var r,
                    ...
                    V = function (t, i) {
                      ...
                      for (
                        k -= i, j += i, A -= i, E += i;
                        r && (o = o.offsetParent) && o != e.body && o != s;
                      ...
                      if ((u = n.loadMode) && D < 8 && (t = _.length)) {
                        ...
                        for (; o < t; o++)
                          if (_[o] && !_[o]._lazyRace)
                            if (N)
                              if (
                                (((d = _[o].getAttribute("data-expand")) &&
                                  (c = 1 * d)) ||
                                  (c = B),
                                m !== c &&
                                  ((x = innerWidth + c * L),
                    ...
                    Z = S(function (t, e, i, s, o) {
                      var r, a, h, u, f, m;
                      (f = v(t, "lazybeforeunveil", e)).defaultPrevented ||
                        (s &&
                          (i
                            ? _(t, n.autosizesClass)
                            : t.setAttribute("sizes", s)),
                        (a = t.getAttribute(n.srcsetAttr)),
                        (r = t.getAttribute(n.srcAttr)),
                        o &&
                          ((h = t.parentNode),
                          (u = h && c.test(h.nodeName || ""))),
                        (m = e.firesLoad || ("src" in t && (a || r || u))),
                        (f = { target: t }),
                        m &&
                          (y(t, W, !0),
                          clearTimeout(p),
                          ...
                          _(t, n.loadingClass),
                          y(t, Q, !0)),
                        u && d.call(h.getElementsByTagName("source"), G),
                        a
                          ? t.setAttribute("srcset", a)
                          : r &&
                            !u &&
                            (F.test(t.nodeName) ? U(t, r) : (t.src = r)),
                        o && (a || u) && b(t, { src: r })),
                  ...
                  return {
                    _: function () {
                      (f = o.now()),
                        ...
                        a("resize", X, !0),
                        t.MutationObserver
                          ? new MutationObserver(X).observe(s, {
                              childList: !0,
                              subtree: !0,
                              attributes: !0,
                            })
                          : (s.addEventListener("DOMNodeInserted", X, !0),
                            s.addEventListener("DOMAttrModified", X, !0),
                            setInterval(X, 999)),
                        a("hashchange", X, !0),
                        [
                          "focus",
                        ...
                        /d$|^c/.test(e.readyState)
                          ? K()
                          : (a("load", K),
                            e.addEventListener("DOMContentLoaded", X),
                            l(K, 2e4)),
    ...
    76: [
      function (t, e, i) {
        function n(t, e) {
          for (
            var i, n = [], s = 0, o = 0, r = "", a = (e && e.delimiter) || "/";
            null != (i = y.exec(t));
          ...
          return function (i, n) {
            for (
              var s = "",
                a = i || {},
                l = n || {},
                h = l.pretty ? o : encodeURIComponent,
                p = 0;
              p < t.length;
              p++
            ) {
              ...
              if ("string" != typeof c) {
                ...
                if (g(f)) {
                  ...
                  if (((u = c.asterisk ? r(f) : h(f)), !e[p].test(u)))
                    throw new TypeError(
                      'Expected "' +
                        c.name +
                        '" to match "' +
        ...
        function m(t, e, i) {
          g(e) || ((i = e || i), (e = [])), (i = i || {});
          for (
            var n = i.strict, s = !1 !== i.end, o = "", r = 0;
            r < t.length;
            r++
          ) {
            var a = t[r];
        ...
        (function (i) {
          for (
            var n = t("performance-now"),
              s = "undefined" == typeof window ? i : window,
              o = ["moz", "webkit"],
              r = "AnimationFrame",
              a = s["request" + r],
              l = s["cancel" + r] || s["cancelRequest" + r],
              h = 0;
            !a && h < o.length;
            h++
          )
          ...
          if (!a || !l) {
            ...
            (a = function (t) {
              ...
              return u.push({ handle: ++c, callback: t, cancelled: !1 }), c;
            }),
              (l = function (t) {
      ...
      function (t, e, i) {
        ...
        s(a, n),
          ...
          (a.prototype.showScreen = function (t, e, i) {
            if (!this.getItem(t))
              throw new Error(
                "ScreenNavigator - the item with the id " + t + " doesn't exist"
              );
          ...
          (a.prototype.dispose = function (t) {
            ...
            for (var e in this.items)
              this.items[e].dispose(t), delete this.items[e];
            this.transition = null;
          }),
          (a.prototype.disposePreviousScreen = function () {
            this.previousScreen &&
              (this.getItem(this.previousItemId).disposeScreen(
                this.previousScreen
              ),
              (this.previousScreen = null));
          }),
          (a.prototype.disposeCurrentScreen = function () {
            this.currentScreen &&
              (this.getItem(this.currentItemId).disposeScreen(
                this.currentScreen
              ),
              (this.currentScreen = null));
          }),
        ...
        (n.prototype.setOptions = function (t) {
          ...
          (n.prototype.addEventsListeners = function (t) {
            ...
            for (var e in this.events)
              "function" == typeof this.events[e] && t.on(e, this.events[e]);
          }),
          (n.prototype.removeEventsListeners = function (t) {
            this.hasEventsListeners = !1;
            for (var e in this.events)
              "function" == typeof this.events[e] && t.off(e, this.events[e]);
          }),
          (n.prototype.disposeScreen = function (t, e) {
            this.events && this.removeEventsListeners(t),
              (e || this.canDispose) &&
                ("function" == typeof t.dispose && t.dispose(),
                (this.internalInstance = null));
          }),
    ...
    84: [
      function (t, e, i) {
        e.exports = function (t, e, i) {
          ...
          return (
            t ? (t.on("animateInComplete", s), t.animateIn()) : o(),
            function () {
    ...
    85: [
      function (t, e, i) {
        e.exports = function (t, e, i) {
          ...
          return (
            t ? (t.on("animateInComplete", o), t.animateIn()) : n(),
            function () {
    ...
    86: [
      function (t, e, i) {
        e.exports = function (t, e, i) {
          return e && e.animateOut(), t && t.animateIn(), i(), function () {};
        };
      },
      {},
    ],
    87: [
      function (t, e, i) {
        e.exports = function (t, e, i) {
          ...
          return (
            e ? (e.on("animateOutComplete", s), e.animateOut()) : o(),
            function () {
              n(), e && e.animateOut(!0), t && t.animateIn(!0);
            }
          );
    ...
    89: [
      function (t, e, i) {
        e.exports = function (t, e, i) {
          ...
          return (
            e ? (e.on("animateOutComplete", n), e.animateOut()) : o(),
            function () {
        ...
        o(l, s),
          (l.prototype.play = function () {
            return (
              ...
              (this.complete = !1),
              this.manualUpdate ||
                (this.enterFrameId = a.add(this.enterFrameCb)),
              this
            );
          }),
          ...
          (l.prototype.onComplete = function () {
            return (
              this.loop
                ? (this.yoyo && (this.reversed = !this.reversed),
                  this.reversed
                    ? this.gotoAndPlay(this.lastFrame)
                    : this.gotoAndPlay(0))
                : this.pause(),
              this.emit("complete"),
              this
          ...
          (l.prototype.onEnterFrame = function (t) {
            if (
              t - this.lastFrameTime > this.interval ||
              0 === this.lastFrameTime
            ) {
              if (
                ((this.lastFrameTime = t),
                this.manualUpdate || this.renderFrame(),
                this.complete)
              )
                return void this.onComplete();
              this.isPlaying &&
                (this.reversed ? this.prevFrame() : this.nextFrame()),
          ...
          (e.exports.OffScreenCanvasRenderer = t(
            "./renderer/OffScreenCanvasRenderer.js"
          )),
        ...
        (o.prototype.start = function () {
          ...
          (o.prototype.onTick = function (t) {
            ...
            for (var e = 0, i = this.items.length; e < i; e++)
              this.items[e] && this.items[e].cb(t);
          }),
          (e.exports = o);
      },
      { raf: 79 },
    ...
    92: [
      function (t, e, i) {
        ...
        var n = function (t, e) {
          ...
          for (var i, n = 0; n < this.numFrames; n++)
            (i = t.frames[n].frame),
              this.frames.push({
                index: n,
                x: i.x * e,
          ...
          t: for (var r = 0; r < o; r++)
            for (var a = 0; a < s; a++)
              if (
                ...
                this.frames.length === this.numFrames)
              )
                break t;
        }),
          (e.exports = s);
    ...
    94: [
      ...
      { "../utils/default-values": 97, "../utils/is-array": 98 },
    ],
    95: [
      function (t, e, i) {
        "use strict";
        ...
        (s.prototype.updateSprite = function () {
          ...
          (s.prototype.render = function (t) {
            t.spriteIndex !== this.spriteIndex &&
              ((this.spriteIndex = t.spriteIndex), this.updateSprite()),
              (this.element.style.backgroundPosition =
                "-" +
                t.x * this.scaleFactor +
                "px -" +
                t.y * this.scaleFactor +
                "px");
          }),
          (e.exports = s);
      },
        ...
        (s.prototype.render = function (t, e) {
          this.clearFrame && this.context.clearRect(0, 0, t.width, t.height),
            ...
            this.context.putImageData(
              this.bufferContext.getImageData(t.x, t.y, t.width, t.height),
              e.x,
              e.y,
              0,
              0,
    ...
    100: [
      function (t, e, i) {
        var n = t("./throttle"),
          s = t("./debounce");
        e.exports = { throttle: n, debounce: s };
      },
      { "./debounce": 99, "./throttle": 101 },
    ],
    101: [
      function (t, e, i) {
          ...
          function s() {
            ...
            n && !o && s(),
              ...
              void 0 === n && h > t
                ? s()
                : !0 !== e &&
                  (o = setTimeout(n ? a : s, void 0 === n ? t - h : t));
          }
          var o,
            r = 0;
